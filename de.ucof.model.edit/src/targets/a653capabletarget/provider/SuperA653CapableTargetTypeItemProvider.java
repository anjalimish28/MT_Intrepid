/**
 */
package targets.a653capabletarget.provider;
...
/**
 * This is the item provider adapter for a {@link targets.a653capabletarget.SuperA653CapableTargetType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SuperA653CapableTargetTypeItemProvider 
	 ...
	 * @generated
	 */
	public SuperA653CapableTargetTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((SuperA653CapableTargetType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SuperA653CapableTargetType_type") :
			getString("_UI_SuperA653CapableTargetType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SuperA653CapableTargetType.class)) {
