...
/**
 * This is the item provider adapter for a {@link targets.avip.SignalExtensions} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SignalExtensionsItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SignalExtensionsItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AvipPackage.Literals.SIGNAL_EXTENSIONS__SIGNAL_EXTENSION);
		}
	...
	/**
	 * This returns SignalExtensions.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SignalExtensions"));
	}
	...
	public String getText(Object object) {
		String label = ((SignalExtensions)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SignalExtensions_type") :
			getString("_UI_SignalExtensions_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SignalExtensions.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AvipPackage.Literals.SIGNAL_EXTENSIONS__SIGNAL_EXTENSION,
				 AvipFactory.eINSTANCE.createSignalExtension()));
	}
