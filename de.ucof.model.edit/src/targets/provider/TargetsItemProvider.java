...
/**
 * This is the item provider adapter for a {@link targets.Targets} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TargetsItemProvider 
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Targets"));
	}
	...
	public String getText(Object object) {
		String label = ((Targets)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Targets_type") :
			getString("_UI_Targets_type") + " " + label;
	}
		...
		newChildDescriptors.add
			(createChildParameter
				(TargetsPackage.Literals.TARGETS__TARGET_CONFIGURATION,
				 ConfigdeskFactory.eINSTANCE.createConfigurationDesk()));

		newChildDescriptors.add
			(createChildParameter
				(TargetsPackage.Literals.TARGETS__TARGET_CONFIGURATION,
				 Tricore299a653p4Factory.eINSTANCE.createTriCore299()));

		newChildDescriptors.add
			(createChildParameter
				(TargetsPackage.Literals.TARGETS__TARGET_CONFIGURATION,
				 MatlabFactory.eINSTANCE.createSimulinkProject()));

		newChildDescriptors.add
			(createChildParameter
				(TargetsPackage.Literals.TARGETS__TARGET_CONFIGURATION,
				 Vxworksa653Factory.eINSTANCE.createVxWorksA653()));

		newChildDescriptors.add
			(createChildParameter
				(TargetsPackage.Literals.TARGETS__TARGET_CONFIGURATION,
				 AvipFactory.eINSTANCE.createAvionicsVirtualDevice()));
	}
