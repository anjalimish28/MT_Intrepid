...
/**
 * This is the item provider adapter for a {@link ucof.assignments.Assignments} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AssignmentsItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public AssignmentsItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AssignmentsPackage.Literals.ASSIGNMENTS__ASSIGNMENT_SET);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Assignments"));
	}
	...
	public String getText(Object object) {
		String label = ((Assignments)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Assignments_type") :
			getString("_UI_Assignments_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Assignments.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AssignmentsPackage.Literals.ASSIGNMENTS__ASSIGNMENT_SET,
				 AssignmentsFactory.eINSTANCE.createInterfaceToPort2PortAssignmentSet()));

		newChildDescriptors.add
			(createChildParameter
				(AssignmentsPackage.Literals.ASSIGNMENTS__ASSIGNMENT_SET,
				 AssignmentsFactory.eINSTANCE.createDeviceToImplementationAssignmentSet()));

		newChildDescriptors.add
			(createChildParameter
				(AssignmentsPackage.Literals.ASSIGNMENTS__ASSIGNMENT_SET,
				 AssignmentsFactory.eINSTANCE.createInterfaceToHardwareAssignmentSet()));

		newChildDescriptors.add
			(createChildParameter
				(AssignmentsPackage.Literals.ASSIGNMENTS__ASSIGNMENT_SET,
				 AssignmentsFactory.eINSTANCE.createPortToPortAssignmentSet()));

		newChildDescriptors.add
			(createChildParameter
				(AssignmentsPackage.Literals.ASSIGNMENTS__ASSIGNMENT_SET,
				 AssignmentsFactory.eINSTANCE.createED247AssignmentSet()));

		newChildDescriptors.add
			(createChildParameter
				(AssignmentsPackage.Literals.ASSIGNMENTS__ASSIGNMENT_SET,
				 AssignmentsFactory.eINSTANCE.createSWPortToHWPortAssignmentSet()));

		newChildDescriptors.add
			(createChildParameter
				(AssignmentsPackage.Literals.ASSIGNMENTS__ASSIGNMENT_SET,
				 DatabaseFactory.eINSTANCE.createSignalToTargetAssignmentSet()));

		newChildDescriptors.add
			(createChildParameter
				(AssignmentsPackage.Literals.ASSIGNMENTS__ASSIGNMENT_SET,
				 DatabaseFactory.eINSTANCE.createPayloadToTargetAssignmentSet()));

		newChildDescriptors.add
			(createChildParameter
				(AssignmentsPackage.Literals.ASSIGNMENTS__ASSIGNMENT_SET,
				 DatabaseFactory.eINSTANCE.createMessageToTargetAssignmentSet()));
	}
