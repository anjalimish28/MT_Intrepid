...
/**
 * This is the item provider adapter for a {@link ucof.common.etypes.SuperIdentifierType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SuperIdentifierTypeItemProvider 
	 ...
	 * @generated
	 */
	public SuperIdentifierTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((SuperIdentifierType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SuperIdentifierType_type") :
			getString("_UI_SuperIdentifierType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SuperIdentifierType.class)) {
