...
/**
 * This is the item provider adapter for a {@link ucof.common.etypes.SuperSetType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SuperSetTypeItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SuperSetTypeItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This adds a property descriptor for the Setname feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSetnamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SuperSetType_setname_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SuperSetType_setname_feature", "_UI_SuperSetType_type"),
				 EtypesPackage.Literals.SUPER_SET_TYPE__SETNAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((SuperSetType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SuperSetType_type") :
			getString("_UI_SuperSetType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SuperSetType.class)) {
