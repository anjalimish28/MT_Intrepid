...
/**
 * This is the item provider adapter for a {@link ucof.communication.basedonwired.WiredSuper} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WiredSuperItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public WiredSuperItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addConnectorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_WiredSuper_connector_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_WiredSuper_connector_feature", "_UI_WiredSuper_type"),
				 BasedonwiredPackage.Literals.WIRED_SUPER__CONNECTOR,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((WiredSuper)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WiredSuper_type") :
			getString("_UI_WiredSuper_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(WiredSuper.class)) {
