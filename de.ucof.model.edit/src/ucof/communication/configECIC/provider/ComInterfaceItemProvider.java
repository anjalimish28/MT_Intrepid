...
/**
 * This is the item provider adapter for a {@link ucof.communication.configECIC.ComInterface} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComInterfaceItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ComInterfaceItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConfigECICPackage.Literals.COM_INTERFACE__UDP_SOCKETS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ComInterface"));
	}
	...
	public String getText(Object object) {
		String label = ((ComInterface)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ComInterface_type") :
			getString("_UI_ComInterface_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ComInterface.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConfigECICPackage.Literals.COM_INTERFACE__UDP_SOCKETS,
				 ConfigECICFactory.eINSTANCE.createUDPSockets()));
	}
