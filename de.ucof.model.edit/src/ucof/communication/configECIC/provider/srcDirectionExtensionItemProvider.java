...
/**
 * This is the item provider adapter for a {@link ucof.communication.configECIC.srcDirectionExtension} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class srcDirectionExtensionItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public srcDirectionExtensionItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This adds a property descriptor for the Ip Adress feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIpAdressPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_srcDirectionExtension_ipAdress_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_srcDirectionExtension_ipAdress_feature", "_UI_srcDirectionExtension_type"),
				 ConfigECICPackage.Literals.SRC_DIRECTION_EXTENSION__IP_ADRESS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addPortPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_srcDirectionExtension_port_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_srcDirectionExtension_port_feature", "_UI_srcDirectionExtension_type"),
				 ConfigECICPackage.Literals.SRC_DIRECTION_EXTENSION__PORT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns srcDirectionExtension.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/srcDirectionExtension"));
	}
	...
	public String getText(Object object) {
		String label = ((srcDirectionExtension)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_srcDirectionExtension_type") :
			getString("_UI_srcDirectionExtension_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(srcDirectionExtension.class)) {
