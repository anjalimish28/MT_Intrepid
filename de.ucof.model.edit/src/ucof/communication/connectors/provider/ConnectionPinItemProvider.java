...
/**
 * This is the item provider adapter for a {@link ucof.communication.connectors.ConnectionPin} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnectionPinItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ConnectionPinItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addConnectionPinRolePropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Connection Pin Role feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addConnectionPinRolePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConnectionPin_connectionPinRole_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConnectionPin_connectionPinRole_feature", "_UI_ConnectionPin_type"),
				 ConnectorsPackage.Literals.CONNECTION_PIN__CONNECTION_PIN_ROLE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns ConnectionPin.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ConnectionPin"));
	}
	...
	public String getText(Object object) {
		String label = ((ConnectionPin)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ConnectionPin_type") :
			getString("_UI_ConnectionPin_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ConnectionPin.class)) {
