...
/**
 * This is the item provider adapter for a {@link ucof.communication.SuperMessageType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SuperMessageTypeItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SuperMessageTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((SuperMessageType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SuperMessageType_type") :
			getString("_UI_SuperMessageType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SuperMessageType.class)) {
