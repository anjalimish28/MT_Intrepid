...
/**
 * This is the item provider adapter for a {@link ucof.devices.devicetypes.a653components.healthmanagement.HMTable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HMTableItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public HMTableItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addTableIdentifierPropertyDescriptor(object);
			addTableNamePropertyDescriptor(object);
			addMultiPartitionHMTableNameRefPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Table Identifier feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addTableIdentifierPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HMTable_tableIdentifier_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HMTable_tableIdentifier_feature", "_UI_HMTable_type"),
				 HealthmanagementPackage.Literals.HM_TABLE__TABLE_IDENTIFIER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addTableNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HMTable_tableName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HMTable_tableName_feature", "_UI_HMTable_type"),
				 HealthmanagementPackage.Literals.HM_TABLE__TABLE_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Multi Partition HM Table Name Ref feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addMultiPartitionHMTableNameRefPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HMTable_multiPartitionHMTableNameRef_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HMTable_multiPartitionHMTableNameRef_feature", "_UI_HMTable_type"),
				 HealthmanagementPackage.Literals.HM_TABLE__MULTI_PARTITION_HM_TABLE_NAME_REF,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HealthmanagementPackage.Literals.HM_TABLE__ERROR_INFO);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HMTable"));
	}
	...
	public String getText(Object object) {
		String label = ((HMTable)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_HMTable_type") :
			getString("_UI_HMTable_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(HMTable.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HealthmanagementPackage.Literals.HM_TABLE__ERROR_INFO,
				 HealthmanagementFactory.eINSTANCE.createErroInfoPartition()));
	}
