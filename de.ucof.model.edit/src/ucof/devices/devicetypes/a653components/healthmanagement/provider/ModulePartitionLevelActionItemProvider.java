...
/**
 * This is the item provider adapter for a {@link ucof.devices.devicetypes.a653components.healthmanagement.ModulePartitionLevelAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModulePartitionLevelActionItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ModulePartitionLevelActionItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((ModulePartitionLevelAction)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ModulePartitionLevelAction_type") :
			getString("_UI_ModulePartitionLevelAction_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ModulePartitionLevelAction.class)) {
