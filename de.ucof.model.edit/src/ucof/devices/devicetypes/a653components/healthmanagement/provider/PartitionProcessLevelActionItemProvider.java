...
/**
 * This is the item provider adapter for a {@link ucof.devices.devicetypes.a653components.healthmanagement.PartitionProcessLevelAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PartitionProcessLevelActionItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public PartitionProcessLevelActionItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((PartitionProcessLevelAction)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_PartitionProcessLevelAction_type") :
			getString("_UI_PartitionProcessLevelAction_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PartitionProcessLevelAction.class)) {
