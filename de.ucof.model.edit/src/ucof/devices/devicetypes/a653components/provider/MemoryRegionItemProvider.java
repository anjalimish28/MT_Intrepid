...
/**
 * This is the item provider adapter for a {@link ucof.devices.devicetypes.a653components.MemoryRegion} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MemoryRegionItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public MemoryRegionItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addAccessRightsPropertyDescriptor(object);
		}
	...
	protected void addSizePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MemoryRegion_size_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MemoryRegion_size_feature", "_UI_MemoryRegion_type"),
				 A653componentsPackage.Literals.MEMORY_REGION__SIZE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addAddressPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MemoryRegion_address_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MemoryRegion_address_feature", "_UI_MemoryRegion_type"),
				 A653componentsPackage.Literals.MEMORY_REGION__ADDRESS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Access Rights feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addAccessRightsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MemoryRegion_accessRights_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MemoryRegion_accessRights_feature", "_UI_MemoryRegion_type"),
				 A653componentsPackage.Literals.MEMORY_REGION__ACCESS_RIGHTS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MemoryRegion"));
	}
	...
	public String getText(Object object) {
		String label = ((MemoryRegion)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MemoryRegion_type") :
			getString("_UI_MemoryRegion_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MemoryRegion.class)) {
