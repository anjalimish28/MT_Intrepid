...
/**
 * This is the item provider adapter for a {@link ucof.devices.functions.FunctionLink} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FunctionLinkItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public FunctionLinkItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addFunctionFilePropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Function File feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addFunctionFilePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FunctionLink_functionFile_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FunctionLink_functionFile_feature", "_UI_FunctionLink_type"),
				 FunctionsPackage.Literals.FUNCTION_LINK__FUNCTION_FILE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FunctionLink"));
	}
	...
	public String getText(Object object) {
		String label = ((FunctionLink)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_FunctionLink_type") :
			getString("_UI_FunctionLink_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FunctionLink.class)) {
