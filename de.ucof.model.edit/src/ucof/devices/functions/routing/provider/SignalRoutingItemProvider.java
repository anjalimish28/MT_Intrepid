...
/**
 * This is the item provider adapter for a {@link ucof.devices.functions.routing.SignalRouting} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SignalRoutingItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SignalRoutingItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addInSignalPropertyDescriptor(object);
			addOutSignalPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the In Signal feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addInSignalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SignalRouting_inSignal_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SignalRouting_inSignal_feature", "_UI_SignalRouting_type"),
				 RoutingPackage.Literals.SIGNAL_ROUTING__IN_SIGNAL,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Out Signal feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addOutSignalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SignalRouting_outSignal_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SignalRouting_outSignal_feature", "_UI_SignalRouting_type"),
				 RoutingPackage.Literals.SIGNAL_ROUTING__OUT_SIGNAL,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns SignalRouting.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SignalRouting"));
	}
	...
	public String getText(Object object) {
		String label = ((SignalRouting)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SignalRouting_type") :
			getString("_UI_SignalRouting_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SignalRouting.class)) {
