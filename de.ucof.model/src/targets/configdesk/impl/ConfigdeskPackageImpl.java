...
import targets.configdesk.ConfigdeskFactory;
 ...
 * @generated
 */
public class ConfigdeskPackageImpl extends EPackageImpl implements ConfigdeskPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass configurationDeskEClass = null;
	 ...
	 * @generated
	 */
	private EClass superConfigurationDeskIOHardwareTypeEClass = null;
	 ...
	 * @see targets.configdesk.ConfigdeskPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ConfigdeskPackageImpl() {
		super(eNS_URI, ConfigdeskFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link ConfigdeskPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ConfigdeskPackage init() {
		if (isInited) return (ConfigdeskPackage)EPackage.Registry.INSTANCE.getEPackage(ConfigdeskPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredConfigdeskPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		ConfigdeskPackageImpl theConfigdeskPackage = registeredConfigdeskPackage instanceof ConfigdeskPackageImpl ? (ConfigdeskPackageImpl)registeredConfigdeskPackage : new ConfigdeskPackageImpl();
		...
		theConfigdeskPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ConfigdeskPackage.eNS_URI, theConfigdeskPackage);
		return theConfigdeskPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getConfigurationDesk() {
		return configurationDeskEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getConfigurationDesk_ConfigurationDeskIOHardware() {
		return (EReference)configurationDeskEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getConfigurationDesk_ModelTopologyName() {
		return (EAttribute)configurationDeskEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getConfigurationDesk_ApplicationName() {
		return (EAttribute)configurationDeskEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EClass getSuperConfigurationDeskIOHardwareType() {
		return superConfigurationDeskIOHardwareTypeEClass;
	}
	 ...
	 * @generated
	 */
	public ConfigdeskFactory getConfigdeskFactory() {
		return (ConfigdeskFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		configurationDeskEClass = createEClass(CONFIGURATION_DESK);
		createEReference(configurationDeskEClass, CONFIGURATION_DESK__CONFIGURATION_DESK_IO_HARDWARE);
		createEAttribute(configurationDeskEClass, CONFIGURATION_DESK__MODEL_TOPOLOGY_NAME);
		createEAttribute(configurationDeskEClass, CONFIGURATION_DESK__APPLICATION_NAME);

		superConfigurationDeskIOHardwareTypeEClass = createEClass(SUPER_CONFIGURATION_DESK_IO_HARDWARE_TYPE);
	}
	...
	public void initializePackageContents() {
		...
		EthernetPackage theEthernetPackage = (EthernetPackage)EPackage.Registry.INSTANCE.getEPackage(EthernetPackage.eNS_URI);
		WiredPackage theWiredPackage = (WiredPackage)EPackage.Registry.INSTANCE.getEPackage(WiredPackage.eNS_URI);
		TargetsPackage theTargetsPackage = (TargetsPackage)EPackage.Registry.INSTANCE.getEPackage(TargetsPackage.eNS_URI);

		// Add subpackages
		getESubpackages().add(theDSpaceArinc825Package);
		getESubpackages().add(theEthernetPackage);
		getESubpackages().add(theWiredPackage);
		...
		configurationDeskEClass.getESuperTypes().add(theTargetsPackage.getHardwareInformation());
		configurationDeskEClass.getESuperTypes().add(theTargetsPackage.getSuperTargetType());
		superConfigurationDeskIOHardwareTypeEClass.getESuperTypes().add(theTargetsPackage.getSuperIOHardwareType());

		// Initialize classes, features, and operations; add parameters
		initEClass(configurationDeskEClass, ConfigurationDesk.class, "ConfigurationDesk", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getConfigurationDesk_ConfigurationDeskIOHardware(), this.getSuperConfigurationDeskIOHardwareType(), null, "configurationDeskIOHardware", null, 0, -1, ConfigurationDesk.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getConfigurationDesk_ModelTopologyName(), ecorePackage.getEString(), "modelTopologyName", null, 0, 1, ConfigurationDesk.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getConfigurationDesk_ApplicationName(), ecorePackage.getEString(), "applicationName", null, 0, 1, ConfigurationDesk.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(superConfigurationDeskIOHardwareTypeEClass, SuperConfigurationDeskIOHardwareType.class, "SuperConfigurationDeskIOHardwareType", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
	}

} //ConfigdeskPackageImpl
