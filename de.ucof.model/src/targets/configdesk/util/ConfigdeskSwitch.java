/**
 */
package targets.configdesk.util;
 ...
 * @generated
 */
public class ConfigdeskSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static ConfigdeskPackage modelPackage;
	 ...
	 * @generated
	 */
	public ConfigdeskSwitch() {
		if (modelPackage == null) {
			modelPackage = ConfigdeskPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ConfigdeskPackage.CONFIGURATION_DESK: {
				ConfigurationDesk configurationDesk = (ConfigurationDesk)theEObject;
				T result = caseConfigurationDesk(configurationDesk);
				if (result == null) result = caseHardwareInformation(configurationDesk);
				if (result == null) result = caseSuperTargetType(configurationDesk);
				if (result == null) result = caseSuperIdentifierType(configurationDesk);
				if (result == null) result = caseSuperTrackingType(configurationDesk);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConfigdeskPackage.SUPER_CONFIGURATION_DESK_IO_HARDWARE_TYPE: {
				SuperConfigurationDeskIOHardwareType superConfigurationDeskIOHardwareType = (SuperConfigurationDeskIOHardwareType)theEObject;
				T result = caseSuperConfigurationDeskIOHardwareType(superConfigurationDeskIOHardwareType);
				if (result == null) result = caseSuperIOHardwareType(superConfigurationDeskIOHardwareType);
				if (result == null) result = caseSuperIdentifierType(superConfigurationDeskIOHardwareType);
				if (result == null) result = caseSuperTrackingType(superConfigurationDeskIOHardwareType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Configuration Desk</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Configuration Desk</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseConfigurationDesk(ConfigurationDesk object) {
		return null;
	}
