...
import targets.configdesk.wired.Analogue;
import targets.configdesk.wired.Analogues;
import targets.configdesk.wired.Digital;
import targets.configdesk.wired.Digitals;
import targets.configdesk.wired.WiredFactory;
 ...
 * @generated
 */
public class WiredPackageImpl extends EPackageImpl implements WiredPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass analoguesEClass = null;
	 ...
	 * @generated
	 */
	private EClass digitalsEClass = null;
	 ...
	 * @see targets.configdesk.wired.WiredPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private WiredPackageImpl() {
		super(eNS_URI, WiredFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link WiredPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static WiredPackage init() {
		if (isInited) return (WiredPackage)EPackage.Registry.INSTANCE.getEPackage(WiredPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredWiredPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		WiredPackageImpl theWiredPackage = registeredWiredPackage instanceof WiredPackageImpl ? (WiredPackageImpl)registeredWiredPackage : new WiredPackageImpl();
		...
		theWiredPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(WiredPackage.eNS_URI, theWiredPackage);
		return theWiredPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getAnalogues() {
		return analoguesEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getDigitals() {
		return digitalsEClass;
	}
	 ...
	 * @generated
	 */
	public WiredFactory getWiredFactory() {
		return (WiredFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		analoguesEClass = createEClass(ANALOGUES);

		analogueEClass = createEClass(ANALOGUE);

		digitalsEClass = createEClass(DIGITALS);
	...
	public void initializePackageContents() {
		...
		initEClass(analoguesEClass, Analogues.class, "Analogues", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(analogueEClass, Analogue.class, "Analogue", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(digitalsEClass, Digitals.class, "Digitals", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
