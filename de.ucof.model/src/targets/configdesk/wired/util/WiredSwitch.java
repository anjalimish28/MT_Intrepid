 ...
 * @generated
 */
public class WiredSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case WiredPackage.ANALOGUES: {
				Analogues analogues = (Analogues)theEObject;
				T result = caseAnalogues(analogues);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WiredPackage.ANALOGUE: {
				Analogue analogue = (Analogue)theEObject;
				T result = caseAnalogue(analogue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WiredPackage.DIGITALS: {
				Digitals digitals = (Digitals)theEObject;
				T result = caseDigitals(digitals);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WiredPackage.DIGITAL: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Analogues</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Analogues</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAnalogues(Analogues object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Digitals</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Digitals</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDigitals(Digitals object) {
		return null;
	}
