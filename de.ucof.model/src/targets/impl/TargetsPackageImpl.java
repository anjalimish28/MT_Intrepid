...
public class TargetsPackageImpl extends EPackageImpl implements TargetsPackage {
	...
	public void initializePackageContents() {
		...
		Tricore299a653p4Package theTricore299a653p4Package = (Tricore299a653p4Package)EPackage.Registry.INSTANCE.getEPackage(Tricore299a653p4Package.eNS_URI);
		MatlabPackage theMatlabPackage = (MatlabPackage)EPackage.Registry.INSTANCE.getEPackage(MatlabPackage.eNS_URI);
		...
		Vxworksa653Package theVxworksa653Package = (Vxworksa653Package)EPackage.Registry.INSTANCE.getEPackage(Vxworksa653Package.eNS_URI);
		AvipPackage theAvipPackage = (AvipPackage)EPackage.Registry.INSTANCE.getEPackage(AvipPackage.eNS_URI);
		...
		// Add subpackages
		getESubpackages().add(theConfigdeskPackage);
		getESubpackages().add(theTricore299a653p4Package);
		getESubpackages().add(theMatlabPackage);
		getESubpackages().add(theA653capabletargetPackage);
		getESubpackages().add(theVxworksa653Package);
		getESubpackages().add(theAvipPackage);
