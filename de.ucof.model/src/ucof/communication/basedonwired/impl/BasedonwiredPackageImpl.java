...
import ucof.communication.basedonwired.Discrete;
 ...
 * @generated
 */
public class BasedonwiredPackageImpl extends EPackageImpl implements BasedonwiredPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass wiredInterfacesEClass = null;
	 ...
	 * @generated
	 */
	private EClass wiredSuperEClass = null;
	 ...
	 * @generated
	 */
	private EClass analogueEClass = null;
	 ...
	 * @see ucof.communication.basedonwired.BasedonwiredPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private BasedonwiredPackageImpl() {
		super(eNS_URI, BasedonwiredFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link BasedonwiredPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static BasedonwiredPackage init() {
		if (isInited) return (BasedonwiredPackage)EPackage.Registry.INSTANCE.getEPackage(BasedonwiredPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredBasedonwiredPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		BasedonwiredPackageImpl theBasedonwiredPackage = registeredBasedonwiredPackage instanceof BasedonwiredPackageImpl ? (BasedonwiredPackageImpl)registeredBasedonwiredPackage : new BasedonwiredPackageImpl();
		...
		theBasedonwiredPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(BasedonwiredPackage.eNS_URI, theBasedonwiredPackage);
		return theBasedonwiredPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getWiredInterfaces() {
		return wiredInterfacesEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getWiredInterfaces_WiredInterface() {
		return (EReference)wiredInterfacesEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getWiredSuper() {
		return wiredSuperEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getWiredSuper_Connector() {
		return (EReference)wiredSuperEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getAnalogue() {
		return analogueEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getAnalogue_IncCountStepSize() {
		return (EAttribute)analogueEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getAnalogue_DecCountStepSize() {
		return (EAttribute)analogueEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public BasedonwiredFactory getBasedonwiredFactory() {
		return (BasedonwiredFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		wiredInterfacesEClass = createEClass(WIRED_INTERFACES);
		createEReference(wiredInterfacesEClass, WIRED_INTERFACES__WIRED_INTERFACE);

		wiredSuperEClass = createEClass(WIRED_SUPER);
		createEReference(wiredSuperEClass, WIRED_SUPER__CONNECTOR);

		analogueEClass = createEClass(ANALOGUE);
		createEAttribute(analogueEClass, ANALOGUE__INC_COUNT_STEP_SIZE);
		createEAttribute(analogueEClass, ANALOGUE__DEC_COUNT_STEP_SIZE);
	...
	public void initializePackageContents() {
		...
		wiredInterfacesEClass.getESuperTypes().add(theCommunicationPackage.getSuperCommunicationInterfaceType());
		wiredSuperEClass.getESuperTypes().add(theEtypesPackage.getSuperIdentifierType());
		wiredSuperEClass.getESuperTypes().add(theEtypesPackage.getSuperTrackingType());
		analogueEClass.getESuperTypes().add(this.getWiredSuper());
		discreteEClass.getESuperTypes().add(this.getWiredSuper());

		// Initialize classes, features, and operations; add parameters
		initEClass(wiredInterfacesEClass, WiredInterfaces.class, "WiredInterfaces", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getWiredInterfaces_WiredInterface(), this.getWiredSuper(), null, "wiredInterface", null, 0, -1, WiredInterfaces.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(wiredSuperEClass, WiredSuper.class, "WiredSuper", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getWiredSuper_Connector(), theConnectorsPackage.getConnector(), null, "connector", null, 0, 1, WiredSuper.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(analogueEClass, Analogue.class, "Analogue", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getAnalogue_IncCountStepSize(), ecorePackage.getEInt(), "incCountStepSize", null, 0, 1, Analogue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAnalogue_DecCountStepSize(), ecorePackage.getEInt(), "decCountStepSize", null, 0, 1, Analogue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(discreteEClass, Discrete.class, "Discrete", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
	}

} //BasedonwiredPackageImpl
