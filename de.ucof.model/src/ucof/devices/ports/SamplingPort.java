 ...
 * </p>
 * <ul>
 *   <li>{@link ucof.devices.ports.SamplingPort#getRefreshPeriodORTransmissionRate <em>Refresh Period OR Transmission Rate</em>}</li>
 * </ul>
 *
 * @see ucof.devices.ports.PortsPackage#getSamplingPort()
 * @model
 * @generated
 */
public interface SamplingPort extends SuperInterCommunicationPortType {
	 ...
	 * @see ucof.devices.ports.PortsPackage#getSamplingPort_RefreshPeriodORTransmissionRate()
	...
	/**
	 * Sets the value of the '{@link ucof.devices.ports.SamplingPort#getRefreshPeriodORTransmissionRate <em>Refresh Period OR Transmission Rate</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
