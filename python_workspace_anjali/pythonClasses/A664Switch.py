...
class A664Switch(SuperSwitchType):
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "devicetypes" and not reference_name.lower() == "a664switch":
      element.set("xsi:type", "de.ucof.model.devices.devicetypes:A664Switch")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type A664Switch
    obj = A664Switch()  
