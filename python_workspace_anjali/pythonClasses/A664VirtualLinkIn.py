...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! A664VirtualLinkIn.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class A664VirtualLinkIn(A664VirtualLinkSuper):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "arinc664" and not reference_name.lower() == "a664virtuallinkin":
      element.set("xsi:type", "de.ucof.model.communication.basedonethernet.arinc664:A664VirtualLinkIn")  
    ...
    if self.maxSkew is not None:
      element.set("maxSkew", str(self.maxSkew))  
    # Convert children to nested XML elements
    return element

  def from_xml(self, xml_element):
    # Instantiate an object of type A664VirtualLinkIn
    obj = A664VirtualLinkIn()  
    ...
    if "maxSkew" in xml_element.attrib:
        obj.maxSkew = xml_element.get("maxSkew")
