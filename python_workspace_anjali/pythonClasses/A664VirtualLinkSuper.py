...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! A664VirtualLinkSuper.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class A664VirtualLinkSuper(SuperIdentifierType, SuperTrackingType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "arinc664" and not reference_name.lower() == "a664virtuallinksuper":
      element.set("xsi:type", "de.ucof.model.communication.basedonethernet.arinc664:A664VirtualLinkSuper")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type A664VirtualLinkSuper
    obj = A664VirtualLinkSuper()  
