...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! A825Bus.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class A825Bus(SuperCommunicationInterfaceType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "arinc825" and not reference_name.lower() == "a825bus":
      element.set("xsi:type", "de.ucof.model.communication.arinc825:A825Bus")  
    ...
    if self.baudRate is not None:
      element.set("baudRate", str(self.baudRate))  
    # Convert children to nested XML elements
    return element

  def from_xml(self, xml_element):
    # Instantiate an object of type A825Bus
    obj = A825Bus()  
    ...
    if "baudRate" in xml_element.attrib:
        obj.baudRate = xml_element.get("baudRate")
