...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! ComputingModule.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class ComputingModule(SuperPlatformDeviceType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "devicetypes" and not reference_name.lower() == "computingmodule":
      element.set("xsi:type", "de.ucof.model.devices.devicetypes:ComputingModule")  
    ...
    if self.processorFamily is not None:
      element.set("processorFamily", str(self.processorFamily))  
    if self.vendor is not None:
      element.set("vendor", str(self.vendor))  
    if self.model is not None:
      element.set("model", str(self.model))  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type ComputingModule
    obj = ComputingModule()  
    ...
    if "processorFamily" in xml_element.attrib:
        obj.processorFamily = xml_element.get("processorFamily")
    if "vendor" in xml_element.attrib:
        obj.vendor = xml_element.get("vendor")
    if "model" in xml_element.attrib:
        obj.model = xml_element.get("model")
