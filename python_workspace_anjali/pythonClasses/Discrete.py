...
class Discrete(WiredSuper):
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "basedonwired" and not reference_name.lower() == "discrete":
      element.set("xsi:type", "de.ucof.model.communication.basedonwired:Discrete")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type Discrete
    obj = Discrete()  
