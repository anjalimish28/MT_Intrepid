...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! FileProducer.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class FileProducer(SuperIdentifierType, SuperTrackingType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "configECIC" and not reference_name.lower() == "fileproducer":
      element.set("xsi:type", "de.ucof.model.communication.configECIC:FileProducer")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type FileProducer
    obj = FileProducer()  
