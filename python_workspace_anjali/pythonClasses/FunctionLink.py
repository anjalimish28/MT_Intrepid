...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! FunctionLink.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class FunctionLink(SuperIdentifierType, SuperTrackingType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "functions" and not reference_name.lower() == "functionlink":
      element.set("xsi:type", "de.ucof.model.devices.functions:FunctionLink")  
    ...
    if self.functionFile is not None:
      element.set("functionFile", str(self.functionFile))  
    # Convert children to nested XML elements
    return element

  def from_xml(self, xml_element):
    # Instantiate an object of type FunctionLink
    obj = FunctionLink()  
    ...
    if "functionFile" in xml_element.attrib:
        obj.functionFile = xml_element.get("functionFile")
