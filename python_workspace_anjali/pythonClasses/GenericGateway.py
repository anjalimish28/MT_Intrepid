...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! GenericGateway.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class GenericGateway(SuperCommunicationDeviceType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "comDevices" and not reference_name.lower() == "genericgateway":
      element.set("xsi:type", "de.ucof.model.communication.comDevices:GenericGateway")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type GenericGateway
    obj = GenericGateway()  
