...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! MessageToTargetAssignment.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class MessageToTargetAssignment(SuperAssignmentType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "database" and not reference_name.lower() == "messagetotargetassignment":
      element.set("xsi:type", "de.ucof.model.assignments.database:MessageToTargetAssignment")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type MessageToTargetAssignment
    obj = MessageToTargetAssignment()  
