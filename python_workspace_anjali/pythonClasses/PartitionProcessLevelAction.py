...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! PartitionProcessLevelAction.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class PartitionProcessLevelAction(SuperIdentifierType, SuperTrackingType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "healthmanagement" and not reference_name.lower() == "partitionprocesslevelaction":
      element.set("xsi:type", "de.ucof.model.healthmanagement:PartitionProcessLevelAction")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type PartitionProcessLevelAction
    obj = PartitionProcessLevelAction()  
