...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! PayloadToTargetAssignment.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class PayloadToTargetAssignment(SuperAssignmentType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "database" and not reference_name.lower() == "payloadtotargetassignment":
      element.set("xsi:type", "de.ucof.model.assignments.database:PayloadToTargetAssignment")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type PayloadToTargetAssignment
    obj = PayloadToTargetAssignment()  
