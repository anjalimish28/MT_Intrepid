...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! PowerRail.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class PowerRail(SuperPlatformDeviceType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "devicetypes" and not reference_name.lower() == "powerrail":
      element.set("xsi:type", "de.ucof.model.devices.devicetypes:PowerRail")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type PowerRail
    obj = PowerRail()  
