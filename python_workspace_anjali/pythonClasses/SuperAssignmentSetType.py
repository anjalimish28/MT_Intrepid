...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! SuperAssignmentSetType.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class SuperAssignmentSetType(SuperSetType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "assignments" and not reference_name.lower() == "superassignmentsettype":
      element.set("xsi:type", "de.ucof.model.assignments:SuperAssignmentSetType")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type SuperAssignmentSetType
    obj = SuperAssignmentSetType()  
