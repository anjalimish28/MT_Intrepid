...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! SuperAssignmentSpecificationType.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class SuperAssignmentSpecificationType(SuperIdentifierType, SuperTrackingType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "targets" and not reference_name.lower() == "superassignmentspecificationtype":
      element.set("xsi:type", "de.ucof.model.targets:SuperAssignmentSpecificationType")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type SuperAssignmentSpecificationType
    obj = SuperAssignmentSpecificationType()  
