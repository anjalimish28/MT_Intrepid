...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! SuperDeviceType.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class SuperDeviceType(SuperIdentifierType, SuperTrackingType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "etypes" and not reference_name.lower() == "superdevicetype":
      element.set("xsi:type", "de.ucof.model.common.etypes:SuperDeviceType")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type SuperDeviceType
    obj = SuperDeviceType()  
