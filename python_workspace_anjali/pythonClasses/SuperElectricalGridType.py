...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! SuperElectricalGridType.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class SuperElectricalGridType(SuperIdentifierType, SuperTrackingType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "powergrid" and not reference_name.lower() == "superelectricalgridtype":
      element.set("xsi:type", "de.ucof.model.targets.powergrid:SuperElectricalGridType")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type SuperElectricalGridType
    obj = SuperElectricalGridType()  
