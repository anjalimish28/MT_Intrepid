...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! SuperEthernetMessageType.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class SuperEthernetMessageType(SuperMessageType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "basedonethernet" and not reference_name.lower() == "superethernetmessagetype":
      element.set("xsi:type", "de.ucof.model.communication.basedonethernet:SuperEthernetMessageType")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type SuperEthernetMessageType
    obj = SuperEthernetMessageType()  
