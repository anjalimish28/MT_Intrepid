...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! SuperMessageType.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class SuperMessageType(SuperIdentifierType, SuperTrackingType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "communication" and not reference_name.lower() == "supermessagetype":
      element.set("xsi:type", "de.ucof.model.communication:SuperMessageType")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type SuperMessageType
    obj = SuperMessageType()  
