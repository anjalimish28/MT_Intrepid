...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! SuperTrackingType.
...
class SuperTrackingType():
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "etypes" and not reference_name.lower() == "supertrackingtype":
      element.set("xsi:type", "de.ucof.model.common.etypes:SuperTrackingType")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type SuperTrackingType
    obj = SuperTrackingType()  
