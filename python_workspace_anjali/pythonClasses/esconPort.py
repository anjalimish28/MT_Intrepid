...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! esconPort.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class esconPort(SuperHardwarePortType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "motorcontroller" and not reference_name.lower() == "esconport":
      element.set("xsi:type", "de.ucof.model.targets.motorcontroller:esconPort")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type esconPort
    obj = esconPort()  
