...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! intrepidElectricalInterface.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class intrepidElectricalInterface(SuperElectricalInterfaceType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "intrepidpowergrid" and not reference_name.lower() == "intrepidelectricalinterface":
      element.set("xsi:type", "de.ucof.model.targets.intrepidpowergrid:intrepidElectricalInterface")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type intrepidElectricalInterface
    obj = intrepidElectricalInterface()  
