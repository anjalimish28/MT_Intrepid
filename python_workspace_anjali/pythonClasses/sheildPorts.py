...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! sheildPorts.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class sheildPorts(SuperTrackingType, SuperIdentifierType):
  def __init__(self):
    #attributes
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "sheild" and not reference_name.lower() == "sheildports":
      element.set("xsi:type", "de.ucof.model.targets.sheild:sheildPorts")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type sheildPorts
    obj = sheildPorts()  
