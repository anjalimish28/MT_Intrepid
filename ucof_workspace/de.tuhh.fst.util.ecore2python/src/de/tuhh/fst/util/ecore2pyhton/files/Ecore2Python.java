 ...
 *******************************************************************************/
package de.tuhh.fst.util.ecore2pyhton.files;
...
/**
 * Entry point of the 'Ecore2Python' generation module.
 *
 * @generated
 */
public class Ecore2Python extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "/de/tuhh/fst/util/ecore2pyhton/files/Ecore2Python";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "Ecore2Python" };
  ...
  /**
	 ...
	 * @generated
	 */
	public Ecore2Python(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public Ecore2Python(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
	...
	public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                Ecore2Python generator = new Ecore2Python(modelURI, folder, arguments);
