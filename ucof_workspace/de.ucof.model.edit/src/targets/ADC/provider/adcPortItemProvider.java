 ...
 * @generated
 */
public class adcPortItemProvider extends SuperHardwarePortTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public adcPortItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/adcPort"));
	}
	...
	public String getText(Object object) {
		String label = ((adcPort)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_adcPort_type") :
			getString("_UI_adcPort_type") + " " + label;
	}
