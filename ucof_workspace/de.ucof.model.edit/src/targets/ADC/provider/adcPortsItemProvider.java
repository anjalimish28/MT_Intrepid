 ...
 * @generated
 */
public class adcPortsItemProvider extends SuperTrackingTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public adcPortsItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/adcPorts"));
	}
	...
	public String getText(Object object) {
		String label = ((adcPorts)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_adcPorts_type") :
			getString("_UI_adcPorts_type") + " " + label;
	}
