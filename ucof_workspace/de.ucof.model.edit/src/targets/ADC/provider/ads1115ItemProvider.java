 ...
 * @generated
 */
public class ads1115ItemProvider extends SuperTargetTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ads1115ItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ads1115"));
	}
	...
	public String getText(Object object) {
		String label = ((ads1115)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ads1115_type") :
			getString("_UI_ads1115_type") + " " + label;
	}
