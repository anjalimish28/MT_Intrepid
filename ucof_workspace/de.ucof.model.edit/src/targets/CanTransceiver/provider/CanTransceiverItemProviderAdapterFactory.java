...
public class CantransceiverItemProviderAdapterFactory extends CantransceiverAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	public Adapter createsn65hvd230Adapter() {
		if (sn65hvd230ItemProvider == null) {
			sn65hvd230ItemProvider = new sn65hvd230ItemProvider(this);
		}

		return sn65hvd230ItemProvider;
	}
	...
	public Adapter createcanTransceiverPortsAdapter() {
		if (canTransceiverPortsItemProvider == null) {
			canTransceiverPortsItemProvider = new canTransceiverPortsItemProvider(this);
		}

		return canTransceiverPortsItemProvider;
	}
	...
	public Adapter createcanTransceiverPortAdapter() {
		if (canTransceiverPortItemProvider == null) {
			canTransceiverPortItemProvider = new canTransceiverPortItemProvider(this);
		}

		return canTransceiverPortItemProvider;
	}
	 ...
	 */
	public void dispose() {
		if (sn65hvd230ItemProvider != null) sn65hvd230ItemProvider.dispose();
		if (canTransceiverPortsItemProvider != null) canTransceiverPortsItemProvider.dispose();
		if (canTransceiverPortItemProvider != null) canTransceiverPortItemProvider.dispose();
	}
