 ...
 * @generated
 */
public class canTransceiverPortsItemProvider extends SuperTrackingTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public canTransceiverPortsItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns canTransceiverPorts.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/canTransceiverPorts"));
	}
	...
	public String getText(Object object) {
		String label = ((canTransceiverPorts)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_canTransceiverPorts_type") :
			getString("_UI_canTransceiverPorts_type") + " " + label;
	}
