 ...
 * @generated
 */
public class sn65hvd230ItemProvider extends SuperTargetTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public sn65hvd230ItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/sn65hvd230"));
	}
	...
	public String getText(Object object) {
		String label = ((sn65hvd230)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_sn65hvd230_type") :
			getString("_UI_sn65hvd230_type") + " " + label;
	}
