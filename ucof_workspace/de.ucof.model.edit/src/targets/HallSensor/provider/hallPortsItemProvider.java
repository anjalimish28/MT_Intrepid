 ...
 * @generated
 */
public class hallPortsItemProvider extends SuperTrackingTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public hallPortsItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/hallPorts"));
	}
	...
	public String getText(Object object) {
		String label = ((hallPorts)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_hallPorts_type") :
			getString("_UI_hallPorts_type") + " " + label;
	}
