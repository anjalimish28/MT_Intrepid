 ...
 * @generated
 */
public class mts360ItemProvider extends SuperTargetTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public mts360ItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/mts360"));
	}
	...
	public String getText(Object object) {
		String label = ((mts360)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_mts360_type") :
			getString("_UI_mts360_type") + " " + label;
	}
