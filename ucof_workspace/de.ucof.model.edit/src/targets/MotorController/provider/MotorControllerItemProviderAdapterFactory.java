...
public class MotorControllerItemProviderAdapterFactory extends MotorControllerAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	public Adapter createescon409510Adapter() {
		if (escon409510ItemProvider == null) {
			escon409510ItemProvider = new escon409510ItemProvider(this);
		}

		return escon409510ItemProvider;
	}
	...
	public Adapter createesconPortsAdapter() {
		if (esconPortsItemProvider == null) {
			esconPortsItemProvider = new esconPortsItemProvider(this);
		}

		return esconPortsItemProvider;
	}
	...
	public Adapter createesconPortAdapter() {
		if (esconPortItemProvider == null) {
			esconPortItemProvider = new esconPortItemProvider(this);
		}

		return esconPortItemProvider;
	}
	 ...
	 */
	public void dispose() {
		if (escon409510ItemProvider != null) escon409510ItemProvider.dispose();
		if (esconPortsItemProvider != null) esconPortsItemProvider.dispose();
		if (esconPortItemProvider != null) esconPortItemProvider.dispose();
	}
