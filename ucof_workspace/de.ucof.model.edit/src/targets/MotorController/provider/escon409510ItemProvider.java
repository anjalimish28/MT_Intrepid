 ...
 * @generated
 */
public class escon409510ItemProvider extends SuperTargetTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public escon409510ItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/escon409510"));
	}
	...
	public String getText(Object object) {
		String label = ((escon409510)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_escon409510_type") :
			getString("_UI_escon409510_type") + " " + label;
	}
