 ...
 * @generated
 */
public class esconPortItemProvider extends SuperHardwarePortTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public esconPortItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/esconPort"));
	}
	...
	public String getText(Object object) {
		String label = ((esconPort)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_esconPort_type") :
			getString("_UI_esconPort_type") + " " + label;
	}
