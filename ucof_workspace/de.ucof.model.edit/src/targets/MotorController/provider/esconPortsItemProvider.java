 ...
 * @generated
 */
public class esconPortsItemProvider extends SuperTrackingTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public esconPortsItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/esconPorts"));
	}
	...
	public String getText(Object object) {
		String label = ((esconPorts)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_esconPorts_type") :
			getString("_UI_esconPorts_type") + " " + label;
	}
