...
public class RDCItemProviderAdapterFactory extends RDCAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	public Adapter createstm32f446reAdapter() {
		if (stm32f446reItemProvider == null) {
			stm32f446reItemProvider = new stm32f446reItemProvider(this);
		}

		return stm32f446reItemProvider;
	}
	...
	public Adapter createstmPortsAdapter() {
		if (stmPortsItemProvider == null) {
			stmPortsItemProvider = new stmPortsItemProvider(this);
		}

		return stmPortsItemProvider;
	}
	...
	public Adapter createstmPortAdapter() {
		if (stmPortItemProvider == null) {
			stmPortItemProvider = new stmPortItemProvider(this);
		}

		return stmPortItemProvider;
	}
