 ...
 * @generated
 */
public class stmPortsItemProvider extends SuperTrackingTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public stmPortsItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/stmPorts"));
	}
	...
	public String getText(Object object) {
		String label = ((stmPorts)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_stmPorts_type") :
			getString("_UI_stmPorts_type") + " " + label;
	}
