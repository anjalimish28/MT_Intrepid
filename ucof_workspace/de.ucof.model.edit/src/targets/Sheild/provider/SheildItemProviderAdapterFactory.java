 ...
 * @generated
 */
public class SheildItemProviderAdapterFactory extends SheildAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	/**
	 ...
	 * @generated
	 */
	public SheildItemProviderAdapterFactory() {
	...
	public Adapter createarduinosheildAdapter() {
		if (arduinosheildItemProvider == null) {
			arduinosheildItemProvider = new arduinosheildItemProvider(this);
		}

		return arduinosheildItemProvider;
	}
	...
	public Adapter createsheildPortsAdapter() {
		if (sheildPortsItemProvider == null) {
			sheildPortsItemProvider = new sheildPortsItemProvider(this);
		}

		return sheildPortsItemProvider;
	}
	...
	public Adapter createsheildPortAdapter() {
		if (sheildPortItemProvider == null) {
			sheildPortItemProvider = new sheildPortItemProvider(this);
		}

		return sheildPortItemProvider;
	}
	 ...
	 */
	public void dispose() {
		if (arduinosheildItemProvider != null) arduinosheildItemProvider.dispose();
		if (sheildPortsItemProvider != null) sheildPortsItemProvider.dispose();
		if (sheildPortItemProvider != null) sheildPortItemProvider.dispose();
	}
