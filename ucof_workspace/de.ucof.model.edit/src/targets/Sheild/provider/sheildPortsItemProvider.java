 ...
 * @generated
 */
public class sheildPortsItemProvider extends SuperTrackingTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public sheildPortsItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SheildPackage.Literals.SHEILD_PORTS__PORT);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/sheildPorts"));
	}
	...
	public String getText(Object object) {
		String label = ((sheildPorts)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_sheildPorts_type") :
			getString("_UI_sheildPorts_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(sheildPorts.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SheildPackage.Literals.SHEILD_PORTS__PORT,
