...
/**
 * This is the item provider adapter for a {@link targets.avip.AVDPorts} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AVDPortsItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public AVDPortsItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AvipPackage.Literals.AVD_PORTS__PORT);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AVDPorts"));
	}
	...
	public String getText(Object object) {
		String label = ((AVDPorts)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_AVDPorts_type") :
			getString("_UI_AVDPorts_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AVDPorts.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AvipPackage.Literals.AVD_PORTS__PORT,
				 AvipFactory.eINSTANCE.createAnalogueInput()));

		newChildDescriptors.add
			(createChildParameter
				(AvipPackage.Literals.AVD_PORTS__PORT,
				 AvipFactory.eINSTANCE.createAnalogueOutput()));

		newChildDescriptors.add
			(createChildParameter
				(AvipPackage.Literals.AVD_PORTS__PORT,
				 AvipFactory.eINSTANCE.createDiscreteInput()));

		newChildDescriptors.add
			(createChildParameter
				(AvipPackage.Literals.AVD_PORTS__PORT,
				 AvipFactory.eINSTANCE.createDiscreteOutput()));

		newChildDescriptors.add
			(createChildParameter
				(AvipPackage.Literals.AVD_PORTS__PORT,
				 AvipFactory.eINSTANCE.createXTalk()));

		newChildDescriptors.add
			(createChildParameter
				(AvipPackage.Literals.AVD_PORTS__PORT,
				 AvipFactory.eINSTANCE.createA429()));

		newChildDescriptors.add
			(createChildParameter
				(AvipPackage.Literals.AVD_PORTS__PORT,
				 AvipFactory.eINSTANCE.createA664()));

		newChildDescriptors.add
			(createChildParameter
				(AvipPackage.Literals.AVD_PORTS__PORT,
				 AvipFactory.eINSTANCE.createCAN()));

		newChildDescriptors.add
			(createChildParameter
				(AvipPackage.Literals.AVD_PORTS__PORT,
				 AvipFactory.eINSTANCE.createMEM()));

		newChildDescriptors.add
			(createChildParameter
				(AvipPackage.Literals.AVD_PORTS__PORT,
				 AvipFactory.eINSTANCE.createV_RTD()));
	}
