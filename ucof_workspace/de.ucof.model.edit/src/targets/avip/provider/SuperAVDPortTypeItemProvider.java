...
/**
 * This is the item provider adapter for a {@link targets.avip.SuperAVDPortType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SuperAVDPortTypeItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SuperAVDPortTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addConnectorPinNamePropertyDescriptor(object);
			addIf_idPropertyDescriptor(object);
		}
	...
	protected void addConnectorNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SuperAVDPortType_ConnectorName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SuperAVDPortType_ConnectorName_feature", "_UI_SuperAVDPortType_type"),
				 AvipPackage.Literals.SUPER_AVD_PORT_TYPE__CONNECTOR_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Connector Pin Name feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addConnectorPinNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SuperAVDPortType_ConnectorPinName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SuperAVDPortType_ConnectorPinName_feature", "_UI_SuperAVDPortType_type"),
				 AvipPackage.Literals.SUPER_AVD_PORT_TYPE__CONNECTOR_PIN_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the If id feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIf_idPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SuperAVDPortType_if_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SuperAVDPortType_if_id_feature", "_UI_SuperAVDPortType_type"),
				 AvipPackage.Literals.SUPER_AVD_PORT_TYPE__IF_ID,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AvipPackage.Literals.SUPER_AVD_PORT_TYPE__FUNCTIONAL_DATA);
			childrenFeatures.add(AvipPackage.Literals.SUPER_AVD_PORT_TYPE__PORT_USER_CONFIGURATION);
			childrenFeatures.add(AvipPackage.Literals.SUPER_AVD_PORT_TYPE__SIGNAL_EXTENSIONS);
		}
	...
	public String getText(Object object) {
		String label = ((SuperAVDPortType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SuperAVDPortType_type") :
			getString("_UI_SuperAVDPortType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SuperAVDPortType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AvipPackage.Literals.SUPER_AVD_PORT_TYPE__FUNCTIONAL_DATA,
				 AvipFactory.eINSTANCE.createFunctionalData()));

		newChildDescriptors.add
			(createChildParameter
				(AvipPackage.Literals.SUPER_AVD_PORT_TYPE__PORT_USER_CONFIGURATION,
				 AvipFactory.eINSTANCE.createPortUserConfiguration()));

		newChildDescriptors.add
			(createChildParameter
				(AvipPackage.Literals.SUPER_AVD_PORT_TYPE__SIGNAL_EXTENSIONS,
				 AvipFactory.eINSTANCE.createSignalExtensions()));
	}
