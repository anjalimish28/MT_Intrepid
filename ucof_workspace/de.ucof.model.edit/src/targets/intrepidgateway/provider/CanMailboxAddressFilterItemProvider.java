...
/**
 * This is the item provider adapter for a {@link targets.intrepidgateway.CanMailboxAddressFilter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CanMailboxAddressFilterItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public CanMailboxAddressFilterItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addAddressSymbolPropertyDescriptor(object);
			addAddressValuePropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Address Symbol feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addAddressSymbolPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CanMailboxAddressFilter_addressSymbol_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CanMailboxAddressFilter_addressSymbol_feature", "_UI_CanMailboxAddressFilter_type"),
				 IntrepidgatewayPackage.Literals.CAN_MAILBOX_ADDRESS_FILTER__ADDRESS_SYMBOL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Address Value feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addAddressValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CanMailboxAddressFilter_addressValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CanMailboxAddressFilter_addressValue_feature", "_UI_CanMailboxAddressFilter_type"),
				 IntrepidgatewayPackage.Literals.CAN_MAILBOX_ADDRESS_FILTER__ADDRESS_VALUE,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns CanMailboxAddressFilter.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CanMailboxAddressFilter"));
	}
	...
	public String getText(Object object) {
		String label = ((CanMailboxAddressFilter)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CanMailboxAddressFilter_type") :
			getString("_UI_CanMailboxAddressFilter_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CanMailboxAddressFilter.class)) {
