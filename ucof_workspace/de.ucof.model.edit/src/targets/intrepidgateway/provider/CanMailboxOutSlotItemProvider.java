...
/**
 * This is the item provider adapter for a {@link targets.intrepidgateway.CanMailboxOutSlot} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CanMailboxOutSlotItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public CanMailboxOutSlotItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addSourceAddressSymbolPropertyDescriptor(object);
			addSourceAddressValuePropertyDescriptor(object);
			addDestinationAddressSymbolPropertyDescriptor(object);
			addDestinationAddressValuePropertyDescriptor(object);
	...
	protected void addPortIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CanMailboxOutSlot_portId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CanMailboxOutSlot_portId_feature", "_UI_CanMailboxOutSlot_type"),
				 IntrepidgatewayPackage.Literals.CAN_MAILBOX_OUT_SLOT__PORT_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Source Address Symbol feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSourceAddressSymbolPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CanMailboxOutSlot_sourceAddressSymbol_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CanMailboxOutSlot_sourceAddressSymbol_feature", "_UI_CanMailboxOutSlot_type"),
				 IntrepidgatewayPackage.Literals.CAN_MAILBOX_OUT_SLOT__SOURCE_ADDRESS_SYMBOL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Source Address Value feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSourceAddressValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CanMailboxOutSlot_sourceAddressValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CanMailboxOutSlot_sourceAddressValue_feature", "_UI_CanMailboxOutSlot_type"),
				 IntrepidgatewayPackage.Literals.CAN_MAILBOX_OUT_SLOT__SOURCE_ADDRESS_VALUE,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Destination Address Symbol feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addDestinationAddressSymbolPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CanMailboxOutSlot_destinationAddressSymbol_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CanMailboxOutSlot_destinationAddressSymbol_feature", "_UI_CanMailboxOutSlot_type"),
				 IntrepidgatewayPackage.Literals.CAN_MAILBOX_OUT_SLOT__DESTINATION_ADDRESS_SYMBOL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Destination Address Value feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addDestinationAddressValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CanMailboxOutSlot_destinationAddressValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CanMailboxOutSlot_destinationAddressValue_feature", "_UI_CanMailboxOutSlot_type"),
				 IntrepidgatewayPackage.Literals.CAN_MAILBOX_OUT_SLOT__DESTINATION_ADDRESS_VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addMulticastPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CanMailboxOutSlot_multicast_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CanMailboxOutSlot_multicast_feature", "_UI_CanMailboxOutSlot_type"),
				 IntrepidgatewayPackage.Literals.CAN_MAILBOX_OUT_SLOT__MULTICAST,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns CanMailboxOutSlot.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CanMailboxOutSlot"));
	}
	...
	public String getText(Object object) {
		String label = ((CanMailboxOutSlot)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CanMailboxOutSlot_type") :
			getString("_UI_CanMailboxOutSlot_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CanMailboxOutSlot.class)) {
