...
/**
 * This is the item provider adapter for a {@link targets.matlab.SimulinkBlock} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SimulinkBlockItemProvider 
	 ...
	 * @generated
	 */
	public SimulinkBlockItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addLibraryLinkPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SimulinkBlock_libraryLink_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SimulinkBlock_libraryLink_feature", "_UI_SimulinkBlock_type"),
				 MatlabPackage.Literals.SIMULINK_BLOCK__LIBRARY_LINK,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns SimulinkBlock.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SimulinkBlock"));
	}
	...
	public String getText(Object object) {
		String label = ((SimulinkBlock)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SimulinkBlock_type") :
			getString("_UI_SimulinkBlock_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SimulinkBlock.class)) {
