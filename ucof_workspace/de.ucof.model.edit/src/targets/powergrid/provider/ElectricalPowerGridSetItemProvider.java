...
/**
 * This is the item provider adapter for a {@link targets.powergrid.ElectricalPowerGridSet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ElectricalPowerGridSetItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ElectricalPowerGridSetItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PowergridPackage.Literals.ELECTRICAL_POWER_GRID_SET__ELECTRICAL_GRID);
		}
	...
	/**
	 * This returns ElectricalPowerGridSet.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ElectricalPowerGridSet"));
	}
	...
	public String getText(Object object) {
		String label = ((ElectricalPowerGridSet)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ElectricalPowerGridSet_type") :
			getString("_UI_ElectricalPowerGridSet_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ElectricalPowerGridSet.class)) {
