...
/**
 * This is the item provider adapter for a {@link targets.powergrid.PowerConnectionSet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PowerConnectionSetItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public PowerConnectionSetItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PowergridPackage.Literals.POWER_CONNECTION_SET__POWER_CONNECTION);
		}
	...
	/**
	 * This returns PowerConnectionSet.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PowerConnectionSet"));
	}
	...
	public String getText(Object object) {
		String label = ((PowerConnectionSet)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_PowerConnectionSet_type") :
			getString("_UI_PowerConnectionSet_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PowerConnectionSet.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PowergridPackage.Literals.POWER_CONNECTION_SET__POWER_CONNECTION,
				 PowergridFactory.eINSTANCE.createPowerConnection()));
	}
