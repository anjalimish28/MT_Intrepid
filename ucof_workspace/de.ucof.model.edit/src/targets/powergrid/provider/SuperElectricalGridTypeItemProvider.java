...
/**
 * This is the item provider adapter for a {@link targets.powergrid.SuperElectricalGridType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SuperElectricalGridTypeItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SuperElectricalGridTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addDefinedVoltagePropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Defined Voltage feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addDefinedVoltagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SuperElectricalGridType_definedVoltage_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SuperElectricalGridType_definedVoltage_feature", "_UI_SuperElectricalGridType_type"),
				 PowergridPackage.Literals.SUPER_ELECTRICAL_GRID_TYPE__DEFINED_VOLTAGE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addNominalVoltagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SuperElectricalGridType_nominalVoltage_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SuperElectricalGridType_nominalVoltage_feature", "_UI_SuperElectricalGridType_type"),
				 PowergridPackage.Literals.SUPER_ELECTRICAL_GRID_TYPE__NOMINAL_VOLTAGE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((SuperElectricalGridType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SuperElectricalGridType_type") :
			getString("_UI_SuperElectricalGridType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SuperElectricalGridType.class)) {
