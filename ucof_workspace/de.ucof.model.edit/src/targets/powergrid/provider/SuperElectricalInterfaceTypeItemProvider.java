...
/**
 * This is the item provider adapter for a {@link targets.powergrid.SuperElectricalInterfaceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SuperElectricalInterfaceTypeItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SuperElectricalInterfaceTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((SuperElectricalInterfaceType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SuperElectricalInterfaceType_type") :
			getString("_UI_SuperElectricalInterfaceType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SuperElectricalInterfaceType.class)) {
