...
/**
 * This is the item provider adapter for a {@link targets.SuperAssignmentSpecificationType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SuperAssignmentSpecificationTypeItemProvider extends SuperIdentifierTypeItemProvider {
	 ...
	 * @generated
	 */
	public SuperAssignmentSpecificationTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addReferencedAssignmentIDPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Referenced Assignment ID feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addReferencedAssignmentIDPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SuperAssignmentSpecificationType_referencedAssignmentID_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SuperAssignmentSpecificationType_referencedAssignmentID_feature", "_UI_SuperAssignmentSpecificationType_type"),
				 TargetsPackage.Literals.SUPER_ASSIGNMENT_SPECIFICATION_TYPE__REFERENCED_ASSIGNMENT_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((SuperAssignmentSpecificationType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SuperAssignmentSpecificationType_type") :
			getString("_UI_SuperAssignmentSpecificationType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SuperAssignmentSpecificationType.class)) {
