...
/**
 * This is the item provider adapter for a {@link targets.SuperClassExtensionType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SuperClassExtensionTypeItemProvider 
	 ...
	 * @generated
	 */
	public SuperClassExtensionTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addExtendedClassIDPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Extended Class ID feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addExtendedClassIDPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SuperClassExtensionType_extendedClassID_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SuperClassExtensionType_extendedClassID_feature", "_UI_SuperClassExtensionType_type"),
				 TargetsPackage.Literals.SUPER_CLASS_EXTENSION_TYPE__EXTENDED_CLASS_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((SuperClassExtensionType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SuperClassExtensionType_type") :
			getString("_UI_SuperClassExtensionType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SuperClassExtensionType.class)) {
