...
/**
 * This is the item provider adapter for a {@link targets.SuperHardwarePortType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SuperHardwarePortTypeItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SuperHardwarePortTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((SuperHardwarePortType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SuperHardwarePortType_type") :
			getString("_UI_SuperHardwarePortType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SuperHardwarePortType.class)) {
