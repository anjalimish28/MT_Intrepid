...
/**
 * This is the item provider adapter for a {@link targets.SuperTargetType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SuperTargetTypeItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SuperTargetTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((SuperTargetType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SuperTargetType_type") :
			getString("_UI_SuperTargetType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SuperTargetType.class)) {
