...
/**
 * This is the item provider adapter for a {@link targets.tricore299a653p4.TriCore299} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TriCore299ItemProvider extends HardwareInformationItemProvider {
	/**
	 ...
	 * @generated
	 */
	public TriCore299ItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Tricore299a653p4Package.Literals.TRI_CORE299__IO_DRIVER);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TriCore299"));
	}
	...
	public String getText(Object object) {
		String label = ((TriCore299)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_TriCore299_type") :
			getString("_UI_TriCore299_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TriCore299.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Tricore299a653p4Package.Literals.TRI_CORE299__IO_DRIVER,
				 Tricore299a653p4Factory.eINSTANCE.createA825DriverConfiguration()));
	}
