...
/**
 * This is the item provider adapter for a {@link ucof.assignments.UDPSocketExtension} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UDPSocketExtensionItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public UDPSocketExtensionItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addPortSelectionPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Port Selection feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addPortSelectionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UDPSocketExtension_portSelection_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UDPSocketExtension_portSelection_feature", "_UI_UDPSocketExtension_type"),
				 AssignmentsPackage.Literals.UDP_SOCKET_EXTENSION__PORT_SELECTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addIpAdressPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UDPSocketExtension_ipAdress_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UDPSocketExtension_ipAdress_feature", "_UI_UDPSocketExtension_type"),
				 AssignmentsPackage.Literals.UDP_SOCKET_EXTENSION__IP_ADRESS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addPortPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UDPSocketExtension_port_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UDPSocketExtension_port_feature", "_UI_UDPSocketExtension_type"),
				 AssignmentsPackage.Literals.UDP_SOCKET_EXTENSION__PORT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns UDPSocketExtension.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UDPSocketExtension"));
	}
	...
	public String getText(Object object) {
		String label = ((UDPSocketExtension)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_UDPSocketExtension_type") :
			getString("_UI_UDPSocketExtension_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UDPSocketExtension.class)) {
