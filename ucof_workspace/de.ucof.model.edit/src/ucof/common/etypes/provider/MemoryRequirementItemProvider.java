...
/**
 * This is the item provider adapter for a {@link ucof.common.etypes.MemoryRequirement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MemoryRequirementItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public MemoryRequirementItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addAccessPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MemoryRequirement_access_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MemoryRequirement_access_feature", "_UI_MemoryRequirement_type"),
				 EtypesPackage.Literals.MEMORY_REQUIREMENT__ACCESS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addMemoryTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MemoryRequirement_memoryType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MemoryRequirement_memoryType_feature", "_UI_MemoryRequirement_type"),
				 EtypesPackage.Literals.MEMORY_REQUIREMENT__MEMORY_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addSizePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MemoryRequirement_size_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MemoryRequirement_size_feature", "_UI_MemoryRequirement_type"),
				 EtypesPackage.Literals.MEMORY_REQUIREMENT__SIZE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addAddressPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MemoryRequirement_address_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MemoryRequirement_address_feature", "_UI_MemoryRequirement_type"),
				 EtypesPackage.Literals.MEMORY_REQUIREMENT__ADDRESS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns MemoryRequirement.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MemoryRequirement"));
	}
	...
	public String getText(Object object) {
		String label = ((MemoryRequirement)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MemoryRequirement_type") :
			getString("_UI_MemoryRequirement_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MemoryRequirement.class)) {
