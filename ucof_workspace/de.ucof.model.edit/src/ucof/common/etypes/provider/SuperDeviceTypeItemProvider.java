...
/**
 * This is the item provider adapter for a {@link ucof.common.etypes.SuperDeviceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SuperDeviceTypeItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SuperDeviceTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addConfigurationLinkPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Configuration Link feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addConfigurationLinkPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SuperDeviceType_configurationLink_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SuperDeviceType_configurationLink_feature", "_UI_SuperDeviceType_type"),
				 EtypesPackage.Literals.SUPER_DEVICE_TYPE__CONFIGURATION_LINK,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EtypesPackage.Literals.SUPER_DEVICE_TYPE__PORTS);
		}
	...
	public String getText(Object object) {
		String label = ((SuperDeviceType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SuperDeviceType_type") :
			getString("_UI_SuperDeviceType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SuperDeviceType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EtypesPackage.Literals.SUPER_DEVICE_TYPE__PORTS,
				 EtypesFactory.eINSTANCE.createDevicePorts()));
	}
