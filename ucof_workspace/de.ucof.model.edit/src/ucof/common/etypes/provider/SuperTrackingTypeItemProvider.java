...
/**
 * This is the item provider adapter for a {@link ucof.common.etypes.SuperTrackingType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SuperTrackingTypeItemProvider 
	 ...
	 * @generated
	 */
	public SuperTrackingTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((SuperTrackingType)object).getDocumentation();
		return label == null || label.length() == 0 ?
			getString("_UI_SuperTrackingType_type") :
			getString("_UI_SuperTrackingType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SuperTrackingType.class)) {
