...
/**
 * This is the item provider adapter for a {@link ucof.communication.configECIC.packageStrategyTypes.Frame} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FrameItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addA825IDPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the A825ID feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addA825IDPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Frame_A825ID_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Frame_A825ID_feature", "_UI_Frame_type"),
				 PackageStrategyTypesPackage.Literals.FRAME__A825ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addResetPeriodicTimerPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Frame_ResetPeriodicTimer_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Frame_ResetPeriodicTimer_feature", "_UI_Frame_type"),
				 PackageStrategyTypesPackage.Literals.FRAME__RESET_PERIODIC_TIMER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
