...
/**
 * This is the item provider adapter for a {@link ucof.communication.configECIC.packageStrategyTypes.Frames} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FramesItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public FramesItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PackageStrategyTypesPackage.Literals.FRAMES__FRAME);
			childrenFeatures.add(PackageStrategyTypesPackage.Literals.FRAMES__LLC);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Frames"));
	}
	...
	public String getText(Object object) {
		String label = ((Frames)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Frames_type") :
			getString("_UI_Frames_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Frames.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PackageStrategyTypesPackage.Literals.FRAMES__FRAME,
				 PackageStrategyTypesFactory.eINSTANCE.createFrame()));

		newChildDescriptors.add
			(createChildParameter
				(PackageStrategyTypesPackage.Literals.FRAMES__LLC,
				 PackageStrategyTypesFactory.eINSTANCE.createLLC()));
	}
