...
/**
 * This is the item provider adapter for a {@link ucof.communication.configECIC.packageStrategyTypes.SuperPacketStrategyType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SuperPacketStrategyTypeItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SuperPacketStrategyTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addPeriodNsPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Period Ns feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addPeriodNsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SuperPacketStrategyType_PeriodNs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SuperPacketStrategyType_PeriodNs_feature", "_UI_SuperPacketStrategyType_type"),
				 PackageStrategyTypesPackage.Literals.SUPER_PACKET_STRATEGY_TYPE__PERIOD_NS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((SuperPacketStrategyType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SuperPacketStrategyType_type") :
			getString("_UI_SuperPacketStrategyType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SuperPacketStrategyType.class)) {
