...
/**
 * This is the item provider adapter for a {@link ucof.communication.configECIC.packageStrategyTypes.TriggerWord} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TriggerWordItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public TriggerWordItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addLabelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TriggerWord_Label_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TriggerWord_Label_feature", "_UI_TriggerWord_type"),
				 PackageStrategyTypesPackage.Literals.TRIGGER_WORD__LABEL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addSDIPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TriggerWord_SDI_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TriggerWord_SDI_feature", "_UI_TriggerWord_type"),
				 PackageStrategyTypesPackage.Literals.TRIGGER_WORD__SDI,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addResetPeriodicTimerPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TriggerWord_ResetPeriodicTimer_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TriggerWord_ResetPeriodicTimer_feature", "_UI_TriggerWord_type"),
				 PackageStrategyTypesPackage.Literals.TRIGGER_WORD__RESET_PERIODIC_TIMER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TriggerWord"));
	}
	...
	public String getText(Object object) {
		String label = ((TriggerWord)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_TriggerWord_type") :
			getString("_UI_TriggerWord_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TriggerWord.class)) {
