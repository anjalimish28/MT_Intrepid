...
/**
 * This is the item provider adapter for a {@link ucof.communication.configECIC.packageStrategyTypes.TriggerWords} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TriggerWordsItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public TriggerWordsItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PackageStrategyTypesPackage.Literals.TRIGGER_WORDS__TRIGGER_WORD);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TriggerWords"));
	}
	...
	public String getText(Object object) {
		String label = ((TriggerWords)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_TriggerWords_type") :
			getString("_UI_TriggerWords_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TriggerWords.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PackageStrategyTypesPackage.Literals.TRIGGER_WORDS__TRIGGER_WORD,
				 PackageStrategyTypesFactory.eINSTANCE.createTriggerWord()));
	}
