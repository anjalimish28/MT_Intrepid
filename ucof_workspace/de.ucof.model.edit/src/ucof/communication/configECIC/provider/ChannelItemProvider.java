...
/**
 * This is the item provider adapter for a {@link ucof.communication.configECIC.Channel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ChannelItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addFrameFormatPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Frame Format feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addFrameFormatPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Channel_frameFormat_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Channel_frameFormat_feature", "_UI_Channel_type"),
				 ConfigECICPackage.Literals.CHANNEL__FRAME_FORMAT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConfigECICPackage.Literals.CHANNEL__COM_INTERFACE);
			childrenFeatures.add(ConfigECICPackage.Literals.CHANNEL__HEADER);
			childrenFeatures.add(ConfigECICPackage.Literals.CHANNEL__STREAM);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConfigECICPackage.Literals.CHANNEL__COM_INTERFACE,
				 ConfigECICFactory.eINSTANCE.createComInterface()));

		newChildDescriptors.add
			(createChildParameter
				(ConfigECICPackage.Literals.CHANNEL__HEADER,
				 ConfigECICFactory.eINSTANCE.createHeader()));

		newChildDescriptors.add
			(createChildParameter
				(ConfigECICPackage.Literals.CHANNEL__STREAM,
				 StreamTypesFactory.eINSTANCE.createA429Stream()));

		newChildDescriptors.add
			(createChildParameter
				(ConfigECICPackage.Literals.CHANNEL__STREAM,
				 StreamTypesFactory.eINSTANCE.createA825Stream()));

		newChildDescriptors.add
			(createChildParameter
				(ConfigECICPackage.Literals.CHANNEL__STREAM,
				 StreamTypesFactory.eINSTANCE.createA664Stream()));

		newChildDescriptors.add
			(createChildParameter
				(ConfigECICPackage.Literals.CHANNEL__STREAM,
				 StreamTypesFactory.eINSTANCE.createETHStream()));

		newChildDescriptors.add
			(createChildParameter
				(ConfigECICPackage.Literals.CHANNEL__STREAM,
				 StreamTypesFactory.eINSTANCE.createDISStream()));

		newChildDescriptors.add
			(createChildParameter
				(ConfigECICPackage.Literals.CHANNEL__STREAM,
				 StreamTypesFactory.eINSTANCE.createANAStream()));

		newChildDescriptors.add
			(createChildParameter
				(ConfigECICPackage.Literals.CHANNEL__STREAM,
				 StreamTypesFactory.eINSTANCE.createNADStream()));
	}
