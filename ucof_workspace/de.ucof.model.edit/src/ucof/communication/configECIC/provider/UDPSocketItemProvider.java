...
/**
 * This is the item provider adapter for a {@link ucof.communication.configECIC.UDPSocket} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UDPSocketItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public UDPSocketItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addMulticastInterfaceIPPropertyDescriptor(object);
			addMulticastTTLPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Multicast Interface IP feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addMulticastInterfaceIPPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UDPSocket_multicastInterfaceIP_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UDPSocket_multicastInterfaceIP_feature", "_UI_UDPSocket_type"),
				 ConfigECICPackage.Literals.UDP_SOCKET__MULTICAST_INTERFACE_IP,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Multicast TTL feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addMulticastTTLPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UDPSocket_multicastTTL_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UDPSocket_multicastTTL_feature", "_UI_UDPSocket_type"),
				 ConfigECICPackage.Literals.UDP_SOCKET__MULTICAST_TTL,
				 true,
				 false,
				 false,
	...
	protected void addDirectionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UDPSocket_direction_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UDPSocket_direction_feature", "_UI_UDPSocket_type"),
				 ConfigECICPackage.Literals.UDP_SOCKET__DIRECTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addIpAdressPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UDPSocket_ipAdress_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UDPSocket_ipAdress_feature", "_UI_UDPSocket_type"),
				 ConfigECICPackage.Literals.UDP_SOCKET__IP_ADRESS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addPortPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UDPSocket_port_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UDPSocket_port_feature", "_UI_UDPSocket_type"),
				 ConfigECICPackage.Literals.UDP_SOCKET__PORT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConfigECICPackage.Literals.UDP_SOCKET__SRC_DIRECTION_EXTENSION);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UDPSocket"));
	}
	...
	public String getText(Object object) {
		String label = ((UDPSocket)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_UDPSocket_type") :
			getString("_UI_UDPSocket_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UDPSocket.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConfigECICPackage.Literals.UDP_SOCKET__SRC_DIRECTION_EXTENSION,
				 ConfigECICFactory.eINSTANCE.createsrcDirectionExtension()));
	}
