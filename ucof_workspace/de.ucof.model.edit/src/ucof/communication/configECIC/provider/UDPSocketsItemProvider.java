...
/**
 * This is the item provider adapter for a {@link ucof.communication.configECIC.UDPSockets} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UDPSocketsItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public UDPSocketsItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConfigECICPackage.Literals.UDP_SOCKETS__UDP_SOCKET);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UDPSockets"));
	}
	...
	public String getText(Object object) {
		String label = ((UDPSockets)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_UDPSockets_type") :
			getString("_UI_UDPSockets_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UDPSockets.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConfigECICPackage.Literals.UDP_SOCKETS__UDP_SOCKET,
				 ConfigECICFactory.eINSTANCE.createUDPSocket()));
	}
