...
/**
 * This is the item provider adapter for a {@link ucof.communication.configECIC.streamTypes.DataTimestamp} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataTimestampItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public DataTimestampItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addSampleDataTimestampOffsetPropertyDescriptor(object);
		}
	...
	protected void addEnablePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataTimestamp_enable_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataTimestamp_enable_feature", "_UI_DataTimestamp_type"),
				 StreamTypesPackage.Literals.DATA_TIMESTAMP__ENABLE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Sample Data Timestamp Offset feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSampleDataTimestampOffsetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataTimestamp_sampleDataTimestampOffset_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataTimestamp_sampleDataTimestampOffset_feature", "_UI_DataTimestamp_type"),
				 StreamTypesPackage.Literals.DATA_TIMESTAMP__SAMPLE_DATA_TIMESTAMP_OFFSET,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns DataTimestamp.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DataTimestamp"));
	}
	...
	public String getText(Object object) {
		String label = ((DataTimestamp)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DataTimestamp_type") :
			getString("_UI_DataTimestamp_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DataTimestamp.class)) {
