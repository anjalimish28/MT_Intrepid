...
/**
 * This is the item provider adapter for a {@link ucof.communication.configECIC.streamTypes.SuperStreamType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SuperStreamTypeItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SuperStreamTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addSampleMaxNumberPropertyDescriptor(object);
			addIcdPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Sample Max Number feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSampleMaxNumberPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SuperStreamType_sampleMaxNumber_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SuperStreamType_sampleMaxNumber_feature", "_UI_SuperStreamType_type"),
				 StreamTypesPackage.Literals.SUPER_STREAM_TYPE__SAMPLE_MAX_NUMBER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Icd feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIcdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SuperStreamType_icd_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SuperStreamType_icd_feature", "_UI_SuperStreamType_type"),
				 StreamTypesPackage.Literals.SUPER_STREAM_TYPE__ICD,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StreamTypesPackage.Literals.SUPER_STREAM_TYPE__DATA_TIMESTAMP);
		}
	...
	public String getText(Object object) {
		String label = ((SuperStreamType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SuperStreamType_type") :
			getString("_UI_SuperStreamType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SuperStreamType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StreamTypesPackage.Literals.SUPER_STREAM_TYPE__DATA_TIMESTAMP,
				 StreamTypesFactory.eINSTANCE.createDataTimestamp()));
	}
