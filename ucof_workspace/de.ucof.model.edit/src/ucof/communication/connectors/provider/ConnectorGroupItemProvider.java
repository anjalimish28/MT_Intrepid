...
/**
 * This is the item provider adapter for a {@link ucof.communication.connectors.ConnectorGroup} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnectorGroupItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ConnectorGroupItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConnectorsPackage.Literals.CONNECTOR_GROUP__CONNECTOR);
		}
	...
	/**
	 * This returns ConnectorGroup.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ConnectorGroup"));
	}
	...
	public String getText(Object object) {
		String label = ((ConnectorGroup)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ConnectorGroup_type") :
			getString("_UI_ConnectorGroup_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ConnectorGroup.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConnectorsPackage.Literals.CONNECTOR_GROUP__CONNECTOR,
				 ConnectorsFactory.eINSTANCE.createConnector()));
	}
