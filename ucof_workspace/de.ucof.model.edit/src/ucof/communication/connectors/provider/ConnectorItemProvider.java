/**
 */
package ucof.communication.connectors.provider;
...
/**
 * This is the item provider adapter for a {@link ucof.communication.connectors.Connector} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnectorItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	...
	protected void addConnectorTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connector_connectorType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connector_connectorType_feature", "_UI_Connector_type"),
				 ConnectorsPackage.Literals.CONNECTOR__CONNECTOR_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addLineTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connector_lineType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connector_lineType_feature", "_UI_Connector_type"),
				 ConnectorsPackage.Literals.CONNECTOR__LINE_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConnectorsPackage.Literals.CONNECTOR__CONNECTION_PIN);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConnectorsPackage.Literals.CONNECTOR__CONNECTION_PIN,
				 ConnectorsFactory.eINSTANCE.createConnectionPin()));
	}
