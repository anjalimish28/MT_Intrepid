...
/**
 * This is the item provider adapter for a {@link ucof.communication.Communication} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CommunicationItemProvider extends SuperTrackingTypeItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CommunicationPackage.Literals.COMMUNICATION__DATABASE);
			childrenFeatures.add(CommunicationPackage.Literals.COMMUNICATION__CONNECTORS);
			childrenFeatures.add(CommunicationPackage.Literals.COMMUNICATION__ED247_CONFIGURATIONS);
			childrenFeatures.add(CommunicationPackage.Literals.COMMUNICATION__COMMUNICATION_DEVICES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CommunicationPackage.Literals.COMMUNICATION__DATABASE,
				 CommunicationFactory.eINSTANCE.createDatabase()));

		newChildDescriptors.add
			(createChildParameter
				(CommunicationPackage.Literals.COMMUNICATION__CONNECTORS,
				 ConnectorsFactory.eINSTANCE.createConnectors()));

		newChildDescriptors.add
			(createChildParameter
				(CommunicationPackage.Literals.COMMUNICATION__ED247_CONFIGURATIONS,
				 ConfigECICFactory.eINSTANCE.createED247Configurations()));

		newChildDescriptors.add
			(createChildParameter
				(CommunicationPackage.Literals.COMMUNICATION__COMMUNICATION_DEVICES,
				 ComDevicesFactory.eINSTANCE.createCommunicationDevices()));
	}
