...
/**
 * This is the item provider adapter for a {@link ucof.communication.Signal} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SignalItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addBitLengthPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CommunicationPackage.Literals.SIGNAL__DATA_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addSignednessPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Signal_signedness_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Signal_signedness_feature", "_UI_Signal_type"),
				 CommunicationPackage.Literals.SIGNAL__SIGNEDNESS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Bit Length feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addBitLengthPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Signal_bitLength_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Signal_bitLength_feature", "_UI_Signal_type"),
				 CommunicationPackage.Literals.SIGNAL__BIT_LENGTH,
				 true,
				 false,
				 false,
	...
	protected void addFactorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Signal_factor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Signal_factor_feature", "_UI_Signal_type"),
				 CommunicationPackage.Literals.SIGNAL__FACTOR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	protected void addOffsetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Signal_offset_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Signal_offset_feature", "_UI_Signal_type"),
				 CommunicationPackage.Literals.SIGNAL__OFFSET,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	protected void addMinValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Signal_minValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Signal_minValue_feature", "_UI_Signal_type"),
				 CommunicationPackage.Literals.SIGNAL__MIN_VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	protected void addMaxValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Signal_maxValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Signal_maxValue_feature", "_UI_Signal_type"),
				 CommunicationPackage.Literals.SIGNAL__MAX_VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CommunicationPackage.Literals.SIGNAL__UNIT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addByteOrderPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Signal_byteOrder_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Signal_byteOrder_feature", "_UI_Signal_type"),
				 CommunicationPackage.Literals.SIGNAL__BYTE_ORDER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CommunicationPackage.Literals.SIGNAL__A429_SPECIFICATION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CommunicationPackage.Literals.SIGNAL__A429_SPECIFICATION,
				 Arinc429Factory.eINSTANCE.createA429SignalSpecification()));
	}
