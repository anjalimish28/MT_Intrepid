...
/**
 * This is the item provider adapter for a {@link ucof.communication.SuperCommunicationInterfaceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SuperCommunicationInterfaceTypeItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SuperCommunicationInterfaceTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((SuperCommunicationInterfaceType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SuperCommunicationInterfaceType_type") :
			getString("_UI_SuperCommunicationInterfaceType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SuperCommunicationInterfaceType.class)) {
