...
/**
 * This is the item provider adapter for a {@link ucof.devices.devicetypes.a653components.a653partition.Partition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PartitionItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addPartitionPeriodPropertyDescriptor(object);
	...
	protected void addCriticalityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Partition_criticality_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Partition_criticality_feature", "_UI_Partition_type"),
				 A653partitionPackage.Literals.PARTITION__CRITICALITY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addEntryPointPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Partition_entryPoint_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Partition_entryPoint_feature", "_UI_Partition_type"),
				 A653partitionPackage.Literals.PARTITION__ENTRY_POINT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Partition Period feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addPartitionPeriodPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Partition_partitionPeriod_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Partition_partitionPeriod_feature", "_UI_Partition_type"),
				 A653partitionPackage.Literals.PARTITION__PARTITION_PERIOD,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addOffsetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Partition_offset_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Partition_offset_feature", "_UI_Partition_type"),
				 A653partitionPackage.Literals.PARTITION__OFFSET,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(A653partitionPackage.Literals.PARTITION__MEMORY);
			childrenFeatures.add(A653partitionPackage.Literals.PARTITION__HM_TABLE);
			childrenFeatures.add(A653partitionPackage.Literals.PARTITION__PARTITION_PORTS);
			childrenFeatures.add(A653partitionPackage.Literals.PARTITION__PROCESSES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(A653partitionPackage.Literals.PARTITION__MEMORY,
				 EtypesFactory.eINSTANCE.createMemory()));

		newChildDescriptors.add
			(createChildParameter
				(A653partitionPackage.Literals.PARTITION__HM_TABLE,
				 HealthmanagementFactory.eINSTANCE.createHMTable()));

		newChildDescriptors.add
			(createChildParameter
				(A653partitionPackage.Literals.PARTITION__PARTITION_PORTS,
				 PortsFactory.eINSTANCE.createPartitionPorts()));

		newChildDescriptors.add
			(createChildParameter
				(A653partitionPackage.Literals.PARTITION__PROCESSES,
				 A653partitionFactory.eINSTANCE.createProcesses()));
	}
