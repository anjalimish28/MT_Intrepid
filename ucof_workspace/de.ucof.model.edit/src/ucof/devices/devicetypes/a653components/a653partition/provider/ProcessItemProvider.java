/**
 */
package ucof.devices.devicetypes.a653components.a653partition.provider;
...
/**
 * This is the item provider adapter for a {@link ucof.devices.devicetypes.a653components.a653partition.Process} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	...
	protected void addEntryPointPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Process_entryPoint_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Process_entryPoint_feature", "_UI_Process_type"),
				 A653partitionPackage.Literals.PROCESS__ENTRY_POINT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addStackSizePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Process_stackSize_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Process_stackSize_feature", "_UI_Process_type"),
				 A653partitionPackage.Literals.PROCESS__STACK_SIZE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Base Priority feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addBasePriorityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Process_basePriority_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Process_basePriority_feature", "_UI_Process_type"),
				 A653partitionPackage.Literals.PROCESS__BASE_PRIORITY,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 A653partitionPackage.Literals.PROCESS__PERIOD,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addTimeCapacityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Process_timeCapacity_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Process_timeCapacity_feature", "_UI_Process_type"),
				 A653partitionPackage.Literals.PROCESS__TIME_CAPACITY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addDeadlinePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Process_deadline_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Process_deadline_feature", "_UI_Process_type"),
				 A653partitionPackage.Literals.PROCESS__DEADLINE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Synchronicity feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSynchronicityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Process_synchronicity_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Process_synchronicity_feature", "_UI_Process_type"),
				 A653partitionPackage.Literals.PROCESS__SYNCHRONICITY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 A653partitionPackage.Literals.PROCESS__DURATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addOffsetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Process_offset_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Process_offset_feature", "_UI_Process_type"),
				 A653partitionPackage.Literals.PROCESS__OFFSET,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(A653partitionPackage.Literals.PROCESS__PROCESS_PORTS);
		}
	...
	public String getText(Object object) {
		String label = ((ucof.devices.devicetypes.a653components.a653partition.Process)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ucof.devices.devicetypes.a653components.a653partition.Process.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(A653partitionPackage.Literals.PROCESS__PROCESS_PORTS,
				 PortsFactory.eINSTANCE.createProcessPorts()));
	}
