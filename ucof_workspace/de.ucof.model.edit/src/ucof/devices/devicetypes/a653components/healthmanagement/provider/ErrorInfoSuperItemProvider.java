...
/**
 * This is the item provider adapter for a {@link ucof.devices.devicetypes.a653components.healthmanagement.ErrorInfoSuper} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ErrorInfoSuperItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ErrorInfoSuperItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addErrorIdentifierPropertyDescriptor(object);
			addErrorDescriptionPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Error Identifier feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addErrorIdentifierPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ErrorInfoSuper_errorIdentifier_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ErrorInfoSuper_errorIdentifier_feature", "_UI_ErrorInfoSuper_type"),
				 HealthmanagementPackage.Literals.ERROR_INFO_SUPER__ERROR_IDENTIFIER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Error Description feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addErrorDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ErrorInfoSuper_errorDescription_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ErrorInfoSuper_errorDescription_feature", "_UI_ErrorInfoSuper_type"),
				 HealthmanagementPackage.Literals.ERROR_INFO_SUPER__ERROR_DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns ErrorInfoSuper.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ErrorInfoSuper"));
	}
	...
	public String getText(Object object) {
		String label = ((ErrorInfoSuper)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ErrorInfoSuper_type") :
			getString("_UI_ErrorInfoSuper_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ErrorInfoSuper.class)) {
