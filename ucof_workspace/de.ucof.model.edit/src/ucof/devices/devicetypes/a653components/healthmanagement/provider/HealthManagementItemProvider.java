...
/**
 * This is the item provider adapter for a {@link ucof.devices.devicetypes.a653components.healthmanagement.HealthManagement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HealthManagementItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public HealthManagementItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HealthmanagementPackage.Literals.HEALTH_MANAGEMENT__MODULE_TABLE);
			childrenFeatures.add(HealthmanagementPackage.Literals.HEALTH_MANAGEMENT__MULTI_PARTITION_TABLES);
		}
	...
	/**
	 * This returns HealthManagement.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HealthManagement"));
	}
	...
	public String getText(Object object) {
		String label = ((HealthManagement)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_HealthManagement_type") :
			getString("_UI_HealthManagement_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(HealthManagement.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HealthmanagementPackage.Literals.HEALTH_MANAGEMENT__MODULE_TABLE,
				 HealthmanagementFactory.eINSTANCE.createModuleTable()));

		newChildDescriptors.add
			(createChildParameter
				(HealthmanagementPackage.Literals.HEALTH_MANAGEMENT__MULTI_PARTITION_TABLES,
				 HealthmanagementFactory.eINSTANCE.createMultiPartitionTables()));
	}
