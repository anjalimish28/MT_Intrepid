...
/**
 * This is the item provider adapter for a {@link ucof.devices.devicetypes.a653components.healthmanagement.MultiPartitionTable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MultiPartitionTableItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public MultiPartitionTableItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addTableIDPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MultiPartitionTable_tableID_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MultiPartitionTable_tableID_feature", "_UI_MultiPartitionTable_type"),
				 HealthmanagementPackage.Literals.MULTI_PARTITION_TABLE__TABLE_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addTableNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MultiPartitionTable_tableName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MultiPartitionTable_tableName_feature", "_UI_MultiPartitionTable_type"),
				 HealthmanagementPackage.Literals.MULTI_PARTITION_TABLE__TABLE_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HealthmanagementPackage.Literals.MULTI_PARTITION_TABLE__ERROR_INFO);
		}
	...
	/**
	 * This returns MultiPartitionTable.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MultiPartitionTable"));
	}
	...
	public String getText(Object object) {
		String label = ((MultiPartitionTable)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MultiPartitionTable_type") :
			getString("_UI_MultiPartitionTable_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MultiPartitionTable.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HealthmanagementPackage.Literals.MULTI_PARTITION_TABLE__ERROR_INFO,
				 HealthmanagementFactory.eINSTANCE.createErrorInfoMultiPartition()));
	}
