...
/**
 * This is the item provider adapter for a {@link ucof.devices.devicetypes.a653components.healthmanagement.MultiPartitionTables} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MultiPartitionTablesItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public MultiPartitionTablesItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HealthmanagementPackage.Literals.MULTI_PARTITION_TABLES__MULTI_PARTITION_TABLE);
		}
	...
	/**
	 * This returns MultiPartitionTables.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MultiPartitionTables"));
	}
	...
	public String getText(Object object) {
		String label = ((MultiPartitionTables)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MultiPartitionTables_type") :
			getString("_UI_MultiPartitionTables_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MultiPartitionTables.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HealthmanagementPackage.Literals.MULTI_PARTITION_TABLES__MULTI_PARTITION_TABLE,
				 HealthmanagementFactory.eINSTANCE.createMultiPartitionTable()));
	}
