...
/**
 * This is the item provider adapter for a {@link ucof.devices.devicetypes.a653components.ModuleSchedule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModuleScheduleItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ModuleScheduleItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(A653componentsPackage.Literals.MODULE_SCHEDULE__PARTITION_TIME_WINDOW);
		}
	...
	/**
	 * This returns ModuleSchedule.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ModuleSchedule"));
	}
	...
	public String getText(Object object) {
		String label = ((ModuleSchedule)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ModuleSchedule_type") :
			getString("_UI_ModuleSchedule_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ModuleSchedule.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(A653componentsPackage.Literals.MODULE_SCHEDULE__PARTITION_TIME_WINDOW,
				 A653componentsFactory.eINSTANCE.createPartitionTimeWindow()));
	}
