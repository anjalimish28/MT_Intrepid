...
/**
 * This is the item provider adapter for a {@link ucof.devices.devicetypes.PowerRail} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PowerRailItemProvider extends SuperPlatformDeviceTypeItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((PowerRail)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_PowerRail_type") :
			getString("_UI_PowerRail_type") + " " + label;
	}
