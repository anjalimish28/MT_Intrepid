...
/**
 * This is the item provider adapter for a {@link ucof.devices.functions.DeviceFunctions} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DeviceFunctionsItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public DeviceFunctionsItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FunctionsPackage.Literals.DEVICE_FUNCTIONS__FUNCTION);
		}
	...
	/**
	 * This returns DeviceFunctions.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DeviceFunctions"));
	}
	...
	public String getText(Object object) {
		String label = ((DeviceFunctions)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DeviceFunctions_type") :
			getString("_UI_DeviceFunctions_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DeviceFunctions.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FunctionsPackage.Literals.DEVICE_FUNCTIONS__FUNCTION,
				 RoutingFactory.eINSTANCE.createRouting()));
	}
