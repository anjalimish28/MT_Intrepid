...
/**
 * This is the item provider adapter for a {@link ucof.devices.functions.SuperFunctionType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SuperFunctionTypeItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SuperFunctionTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FunctionsPackage.Literals.SUPER_FUNCTION_TYPE__FUNCTION_LINK);
		}
	...
	public String getText(Object object) {
		String label = ((SuperFunctionType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SuperFunctionType_type") :
			getString("_UI_SuperFunctionType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SuperFunctionType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FunctionsPackage.Literals.SUPER_FUNCTION_TYPE__FUNCTION_LINK,
				 FunctionsFactory.eINSTANCE.createFunctionLink()));
	}
