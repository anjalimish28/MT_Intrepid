...
/**
 * This is the item provider adapter for a {@link ucof.devices.functions.routing.Routing} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RoutingItemProvider extends SuperFunctionTypeItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RoutingPackage.Literals.ROUTING__PAYLOAD_ROUTING);
			childrenFeatures.add(RoutingPackage.Literals.ROUTING__SIGNAL_ROUTING);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RoutingPackage.Literals.ROUTING__PAYLOAD_ROUTING,
				 RoutingFactory.eINSTANCE.createPayloadRouting()));

		newChildDescriptors.add
			(createChildParameter
				(RoutingPackage.Literals.ROUTING__SIGNAL_ROUTING,
				 RoutingFactory.eINSTANCE.createSignalRouting()));
	}
