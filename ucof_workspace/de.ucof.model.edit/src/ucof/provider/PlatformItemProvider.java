...
/**
 * This is the item provider adapter for a {@link ucof.Platform} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PlatformItemProvider extends SuperIdentifierTypeItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UcofPackage.Literals.PLATFORM__DEVICES);
			childrenFeatures.add(UcofPackage.Literals.PLATFORM__COMMUNICATION);
			childrenFeatures.add(UcofPackage.Literals.PLATFORM__ASSIGNMENTS);
			childrenFeatures.add(UcofPackage.Literals.PLATFORM__TARGETS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UcofPackage.Literals.PLATFORM__DEVICES,
				 DevicesFactory.eINSTANCE.createDevices()));

		newChildDescriptors.add
			(createChildParameter
				(UcofPackage.Literals.PLATFORM__COMMUNICATION,
				 CommunicationFactory.eINSTANCE.createCommunication()));

		newChildDescriptors.add
			(createChildParameter
				(UcofPackage.Literals.PLATFORM__ASSIGNMENTS,
				 AssignmentsFactory.eINSTANCE.createAssignments()));

		newChildDescriptors.add
			(createChildParameter
				(UcofPackage.Literals.PLATFORM__TARGETS,
				 TargetsFactory.eINSTANCE.createTargets()));
	}
