 ...
 * @generated
 */
public class ADCPackageImpl extends EPackageImpl implements ADCPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass ads1115EClass = null;
	 ...
	 * @generated
	 */
	private EClass adcPortsEClass = null;
	 ...
	 * @generated
	 */
	private EClass adcPortEClass = null;
	 ...
	 * @see targets.ADC.ADCPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ADCPackageImpl() {
		super(eNS_URI, ADCFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link ADCPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ADCPackage init() {
		if (isInited) return (ADCPackage)EPackage.Registry.INSTANCE.getEPackage(ADCPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredADCPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		ADCPackageImpl theADCPackage = registeredADCPackage instanceof ADCPackageImpl ? (ADCPackageImpl)registeredADCPackage : new ADCPackageImpl();
		...
		theADCPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ADCPackage.eNS_URI, theADCPackage);
		return theADCPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getads1115() {
		return ads1115EClass;
	}
	 ...
	 * @generated
	 */
	public EReference getads1115_Ports() {
		return (EReference)ads1115EClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getadcPorts() {
		return adcPortsEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getadcPorts_Port() {
		return (EReference)adcPortsEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getadcPort() {
		return adcPortEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getadcPort_PinName() {
		return (EAttribute)adcPortEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public ADCFactory getADCFactory() {
		return (ADCFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		ads1115EClass = createEClass(ADS1115);
		createEReference(ads1115EClass, ADS1115__PORTS);

		adcPortsEClass = createEClass(ADC_PORTS);
		createEReference(adcPortsEClass, ADC_PORTS__PORT);

		adcPortEClass = createEClass(ADC_PORT);
		createEAttribute(adcPortEClass, ADC_PORT__PIN_NAME);
	}
	...
	public void initializePackageContents() {
		...
		ads1115EClass.getESuperTypes().add(theTargetsPackage.getSuperTargetType());
		ads1115EClass.getESuperTypes().add(thePowergridPackage.getSuperPowerType());
		...
		initEReference(getads1115_Ports(), this.getadcPorts(), null, "ports", null, 0, 1, ads1115.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(adcPortsEClass, adcPorts.class, "adcPorts", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getadcPorts_Port(), this.getadcPort(), null, "port", null, 0, -1, adcPorts.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(adcPortEClass, adcPort.class, "adcPort", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getadcPort_PinName(), ecorePackage.getEString(), "pinName", null, 0, 1, adcPort.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
