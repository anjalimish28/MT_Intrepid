 ...
 * @generated
 */
public class CCDPUPackageImpl extends EPackageImpl implements CCDPUPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see targets.CCDPU.CCDPUPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private CCDPUPackageImpl() {
		super(eNS_URI, CCDPUFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link CCDPUPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static CCDPUPackage init() {
		if (isInited) return (CCDPUPackage)EPackage.Registry.INSTANCE.getEPackage(CCDPUPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredCCDPUPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		CCDPUPackageImpl theCCDPUPackage = registeredCCDPUPackage instanceof CCDPUPackageImpl ? (CCDPUPackageImpl)registeredCCDPUPackage : new CCDPUPackageImpl();
		...
		theCCDPUPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(CCDPUPackage.eNS_URI, theCCDPUPackage);
		return theCCDPUPackage;
	}
	 ...
	 * @generated
	 */
	public CCDPUFactory getCCDPUFactory() {
		return (CCDPUFactory)getEFactoryInstance();
	}
