...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>vorago Port</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link targets.CCDPU.impl.voragoPortImpl#getPinName <em>Pin Name</em>}</li>
 *   <li>{@link targets.CCDPU.impl.voragoPortImpl#getPinNumber <em>Pin Number</em>}</li>
 * </ul>
 *
 * @generated
 */
public class voragoPortImpl extends SuperHardwarePortTypeImpl implements voragoPort {
	/**
	...
	protected EClass eStaticClass() {
		return CCDPUPackage.Literals.VORAGO_PORT;
	}
	...
	public void setPinName(String newPinName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CCDPUPackage.VORAGO_PORT__PIN_NAME, oldPinName, pinName));
	}
	...
	public void setPinNumber(int newPinNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CCDPUPackage.VORAGO_PORT__PIN_NUMBER, oldPinNumber, pinNumber));
	}
