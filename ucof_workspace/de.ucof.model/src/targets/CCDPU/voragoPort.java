 ...
 * </p>
 * <ul>
 *   <li>{@link targets.CCDPU.voragoPort#getPinName <em>Pin Name</em>}</li>
 *   <li>{@link targets.CCDPU.voragoPort#getPinNumber <em>Pin Number</em>}</li>
 * </ul>
 *
 * @see targets.CCDPU.CCDPUPackage#getvoragoPort()
 * @model
 * @generated
 */
public interface voragoPort extends SuperHardwarePortType {
	 ...
	 * @see targets.CCDPU.CCDPUPackage#getvoragoPort_PinName()
	 * @model
	 * @generated
	 */
	String getPinName();
	...
	/**
	 * Sets the value of the '{@link targets.CCDPU.voragoPort#getPinName <em>Pin Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see targets.CCDPU.CCDPUPackage#getvoragoPort_PinNumber()
	 * @model
	 * @generated
	 */
	int getPinNumber();
	...
	/**
	 * Sets the value of the '{@link targets.CCDPU.voragoPort#getPinNumber <em>Pin Number</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
