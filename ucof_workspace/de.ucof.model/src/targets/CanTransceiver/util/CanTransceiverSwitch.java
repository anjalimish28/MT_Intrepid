...
public class CanTransceiverSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CanTransceiverPackage.SN65HVD230: {
				...
				if (result == null) result = caseSuperPowerType(sn65hvd230);
				if (result == null) result = caseSuperIdentifierType(sn65hvd230);
				if (result == null) result = caseSuperTrackingType(sn65hvd230);
			...
			case CanTransceiverPackage.CAN_TRANSCEIVER_PORTS: {
				...
				if (result == null) result = caseSuperIdentifierType(canTransceiverPorts);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CanTransceiverPackage.CAN_TRANSCEIVER_PORT: {
				...
				if (result == null) result = caseSuperIdentifierType(canTransceiverPort);
				if (result == null) result = caseSuperTrackingType(canTransceiverPort);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>sn65hvd230</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>sn65hvd230</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casesn65hvd230(sn65hvd230 object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>can Transceiver Ports</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>can Transceiver Ports</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casecanTransceiverPorts(canTransceiverPorts object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>can Transceiver Port</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>can Transceiver Port</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casecanTransceiverPort(canTransceiverPort object) {
		return null;
	}
