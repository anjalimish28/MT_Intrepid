...
import targets.IntrepidElectricalGrid.intrepidElectricalGrid;
import targets.IntrepidElectricalGrid.intrepidElectricalInterface;
 ...
 * @generated
 */
public class IntrepidElectricalGridPackageImpl extends EPackageImpl implements IntrepidElectricalGridPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass intrepidElectricalGridEClass = null;
	 ...
	 * @generated
	 */
	private EClass intrepidElectricalInterfaceEClass = null;
	 ...
	 * @see targets.IntrepidElectricalGrid.IntrepidElectricalGridPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private IntrepidElectricalGridPackageImpl() {
		super(eNS_URI, IntrepidElectricalGridFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link IntrepidElectricalGridPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static IntrepidElectricalGridPackage init() {
		if (isInited) return (IntrepidElectricalGridPackage)EPackage.Registry.INSTANCE.getEPackage(IntrepidElectricalGridPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredIntrepidElectricalGridPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		IntrepidElectricalGridPackageImpl theIntrepidElectricalGridPackage = registeredIntrepidElectricalGridPackage instanceof IntrepidElectricalGridPackageImpl ? (IntrepidElectricalGridPackageImpl)registeredIntrepidElectricalGridPackage : new IntrepidElectricalGridPackageImpl();
		...
		theIntrepidElectricalGridPackage.createPackageContents();
		...
		theIntrepidElectricalGridPackage.initializePackageContents();
		...
		theIntrepidElectricalGridPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(IntrepidElectricalGridPackage.eNS_URI, theIntrepidElectricalGridPackage);
		return theIntrepidElectricalGridPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getintrepidElectricalGrid() {
		return intrepidElectricalGridEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getintrepidElectricalInterface() {
		return intrepidElectricalInterfaceEClass;
	}
	 ...
	 * @generated
	 */
	public IntrepidElectricalGridFactory getIntrepidElectricalGridFactory() {
		return (IntrepidElectricalGridFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		intrepidElectricalGridEClass = createEClass(INTREPID_ELECTRICAL_GRID);

		intrepidElectricalInterfaceEClass = createEClass(INTREPID_ELECTRICAL_INTERFACE);
	}
	...
	public void initializePackageContents() {
		...
		intrepidElectricalGridEClass.getESuperTypes().add(thePowergridPackage.getSuperElectricalGridType());
		intrepidElectricalInterfaceEClass.getESuperTypes().add(thePowergridPackage.getSuperElectricalInterfaceType());

		// Initialize classes, features, and operations; add parameters
		initEClass(intrepidElectricalGridEClass, intrepidElectricalGrid.class, "intrepidElectricalGrid", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
...
} //IntrepidElectricalGridPackageImpl
