...
public class MotorcontrollerPackageImpl extends EPackageImpl implements MotorcontrollerPackage {
	 ...
	 * @generated
	 */
	private EClass escon409510EClass = null;
	 ...
	 * @generated
	 */
	private EClass esconPortsEClass = null;
	 ...
	 * @generated
	 */
	private EClass esconPortEClass = null;
	 ...
	 * @generated
	 */
	public EClass getescon409510() {
		return escon409510EClass;
	}
	 ...
	 * @generated
	 */
	public EReference getescon409510_Ports() {
		return (EReference)escon409510EClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getesconPorts() {
		return esconPortsEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getesconPorts_Port() {
		return (EReference)esconPortsEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getesconPort() {
		return esconPortEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getesconPort_PinName() {
		return (EAttribute)esconPortEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		escon409510EClass = createEClass(ESCON409510);
		createEReference(escon409510EClass, ESCON409510__PORTS);

		esconPortsEClass = createEClass(ESCON_PORTS);
		createEReference(esconPortsEClass, ESCON_PORTS__PORT);

		esconPortEClass = createEClass(ESCON_PORT);
		createEAttribute(esconPortEClass, ESCON_PORT__PIN_NAME);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(escon409510EClass, escon409510.class, "escon409510", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getescon409510_Ports(), this.getesconPorts(), null, "ports", null, 0, 1, escon409510.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(esconPortsEClass, esconPorts.class, "esconPorts", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getesconPorts_Port(), this.getesconPort(), null, "port", null, 0, -1, esconPorts.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(esconPortEClass, esconPort.class, "esconPort", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
