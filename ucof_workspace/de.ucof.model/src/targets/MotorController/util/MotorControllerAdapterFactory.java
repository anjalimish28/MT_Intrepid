...
public class MotorcontrollerAdapterFactory extends AdapterFactoryImpl {
	...
	protected MotorcontrollerSwitch<Adapter> modelSwitch =
		new MotorcontrollerSwitch<Adapter>() {
			...
			@Override
			public Adapter caseesconPorts(esconPorts object) {
				return createesconPortsAdapter();
			}
			@Override
			public Adapter caseesconPort(esconPort object) {
				return createesconPortAdapter();
			}
			@Override
