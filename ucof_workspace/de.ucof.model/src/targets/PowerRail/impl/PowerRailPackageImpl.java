 ...
 * @generated
 */
public class PowerRailPackageImpl extends EPackageImpl implements PowerRailPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass powerRailTargetEClass = null;
	 ...
	 * @generated
	 */
	private EClass powerRailPortsEClass = null;
	 ...
	 * @generated
	 */
	private EClass powerRailPortEClass = null;
	 ...
	 * @see targets.PowerRail.PowerRailPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private PowerRailPackageImpl() {
		super(eNS_URI, PowerRailFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link PowerRailPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static PowerRailPackage init() {
		if (isInited) return (PowerRailPackage)EPackage.Registry.INSTANCE.getEPackage(PowerRailPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredPowerRailPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		PowerRailPackageImpl thePowerRailPackage = registeredPowerRailPackage instanceof PowerRailPackageImpl ? (PowerRailPackageImpl)registeredPowerRailPackage : new PowerRailPackageImpl();
		...
		thePowerRailPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(PowerRailPackage.eNS_URI, thePowerRailPackage);
		return thePowerRailPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getpowerRailTarget() {
		return powerRailTargetEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getpowerRailTarget_Ports() {
		return (EReference)powerRailTargetEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getpowerRailPorts() {
		return powerRailPortsEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getpowerRailPorts_Port() {
		return (EReference)powerRailPortsEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getpowerRailPort() {
		return powerRailPortEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getpowerRailPort_PinName() {
		return (EAttribute)powerRailPortEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public PowerRailFactory getPowerRailFactory() {
		return (PowerRailFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		powerRailTargetEClass = createEClass(POWER_RAIL_TARGET);
		createEReference(powerRailTargetEClass, POWER_RAIL_TARGET__PORTS);

		powerRailPortsEClass = createEClass(POWER_RAIL_PORTS);
		createEReference(powerRailPortsEClass, POWER_RAIL_PORTS__PORT);

		powerRailPortEClass = createEClass(POWER_RAIL_PORT);
		createEAttribute(powerRailPortEClass, POWER_RAIL_PORT__PIN_NAME);
	}
	...
	public void initializePackageContents() {
		...
		powerRailTargetEClass.getESuperTypes().add(theTargetsPackage.getSuperTargetType());
		powerRailPortsEClass.getESuperTypes().add(theEtypesPackage.getSuperTrackingType());
		powerRailPortsEClass.getESuperTypes().add(theEtypesPackage.getSuperIdentifierType());
		powerRailPortEClass.getESuperTypes().add(theTargetsPackage.getSuperHardwarePortType());

		// Initialize classes, features, and operations; add parameters
		initEClass(powerRailTargetEClass, powerRailTarget.class, "powerRailTarget", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getpowerRailTarget_Ports(), this.getpowerRailPorts(), null, "ports", null, 0, 1, powerRailTarget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(powerRailPortsEClass, powerRailPorts.class, "powerRailPorts", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getpowerRailPorts_Port(), this.getpowerRailPort(), null, "port", null, 0, -1, powerRailPorts.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(powerRailPortEClass, powerRailPort.class, "powerRailPort", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getpowerRailPort_PinName(), ecorePackage.getEString(), "pinName", null, 0, 1, powerRailPort.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}

} //PowerRailPackageImpl
