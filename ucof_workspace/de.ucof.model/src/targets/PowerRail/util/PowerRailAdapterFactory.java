 ...
 * @generated
 */
public class PowerRailAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	public PowerRailAdapterFactory() {
	 ...
	 * @generated
	 */
	protected PowerRailSwitch<Adapter> modelSwitch =
		new PowerRailSwitch<Adapter>() {
			@Override
			public Adapter casepowerRailTarget(powerRailTarget object) {
				return createpowerRailTargetAdapter();
			}
			@Override
			public Adapter casepowerRailPorts(powerRailPorts object) {
				return createpowerRailPortsAdapter();
			}
			@Override
			public Adapter casepowerRailPort(powerRailPort object) {
				return createpowerRailPortAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link targets.PowerRail.powerRailTarget <em>power Rail Target</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createpowerRailTargetAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link targets.PowerRail.powerRailPorts <em>power Rail Ports</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createpowerRailPortsAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link targets.PowerRail.powerRailPort <em>power Rail Port</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createpowerRailPortAdapter() {
		return null;
	}
