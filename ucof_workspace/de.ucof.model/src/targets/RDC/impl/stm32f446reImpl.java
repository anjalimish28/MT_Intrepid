 ...
 * </p>
 * <ul>
 *   <li>{@link targets.RDC.impl.stm32f446reImpl#getElectricalInterfaces <em>Electrical Interfaces</em>}</li>
 *   <li>{@link targets.RDC.impl.stm32f446reImpl#getPorts <em>Ports</em>}</li>
 * </ul>
 *
 * @generated
 */
public class stm32f446reImpl extends SuperTargetTypeImpl implements stm32f446re {
	/**
	...
	public NotificationChain basicSetElectricalInterfaces(EletrcialInterfaces newElectricalInterfaces, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RDCPackage.STM32F446RE__ELECTRICAL_INTERFACES, oldElectricalInterfaces, newElectricalInterfaces);
	...
	public void setElectricalInterfaces(EletrcialInterfaces newElectricalInterfaces) {
		if (newElectricalInterfaces != electricalInterfaces) {
			...
			if (electricalInterfaces != null)
				msgs = ((InternalEObject)electricalInterfaces).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RDCPackage.STM32F446RE__ELECTRICAL_INTERFACES, null, msgs);
			if (newElectricalInterfaces != null)
				msgs = ((InternalEObject)newElectricalInterfaces).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RDCPackage.STM32F446RE__ELECTRICAL_INTERFACES, null, msgs);
			msgs = basicSetElectricalInterfaces(newElectricalInterfaces, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RDCPackage.STM32F446RE__ELECTRICAL_INTERFACES, newElectricalInterfaces, newElectricalInterfaces));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == SuperPowerType.class) {
			switch (derivedFeatureID) {
				case RDCPackage.STM32F446RE__ELECTRICAL_INTERFACES: return PowergridPackage.SUPER_POWER_TYPE__ELECTRICAL_INTERFACES;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == SuperPowerType.class) {
			switch (baseFeatureID) {
				case PowergridPackage.SUPER_POWER_TYPE__ELECTRICAL_INTERFACES: return RDCPackage.STM32F446RE__ELECTRICAL_INTERFACES;
				default: return -1;
			}
		}
