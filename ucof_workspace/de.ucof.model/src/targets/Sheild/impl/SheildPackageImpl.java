 ...
 * @generated
 */
public class SheildPackageImpl extends EPackageImpl implements SheildPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass arduinosheildEClass = null;
	 ...
	 * @generated
	 */
	private EClass sheildPortsEClass = null;
	 ...
	 * @generated
	 */
	private EClass sheildPortEClass = null;
	 ...
	 * @see targets.Sheild.SheildPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private SheildPackageImpl() {
		super(eNS_URI, SheildFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link SheildPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static SheildPackage init() {
		if (isInited) return (SheildPackage)EPackage.Registry.INSTANCE.getEPackage(SheildPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredSheildPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		SheildPackageImpl theSheildPackage = registeredSheildPackage instanceof SheildPackageImpl ? (SheildPackageImpl)registeredSheildPackage : new SheildPackageImpl();
		...
		theSheildPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(SheildPackage.eNS_URI, theSheildPackage);
		return theSheildPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getarduinosheild() {
		return arduinosheildEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getarduinosheild_Ports() {
		return (EReference)arduinosheildEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getsheildPorts() {
		return sheildPortsEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getsheildPorts_Port() {
		return (EReference)sheildPortsEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getsheildPort() {
		return sheildPortEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getsheildPort_PinName() {
		return (EAttribute)sheildPortEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public SheildFactory getSheildFactory() {
		return (SheildFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		arduinosheildEClass = createEClass(ARDUINOSHEILD);
		createEReference(arduinosheildEClass, ARDUINOSHEILD__PORTS);

		sheildPortsEClass = createEClass(SHEILD_PORTS);
		createEReference(sheildPortsEClass, SHEILD_PORTS__PORT);

		sheildPortEClass = createEClass(SHEILD_PORT);
		createEAttribute(sheildPortEClass, SHEILD_PORT__PIN_NAME);
	}
	...
	public void initializePackageContents() {
		...
		arduinosheildEClass.getESuperTypes().add(theTargetsPackage.getSuperTargetType());
		arduinosheildEClass.getESuperTypes().add(theTargetsPackage.getSuperIOHardwareType());
		arduinosheildEClass.getESuperTypes().add(thePowergridPackage.getSuperPowerType());
		...
		initEReference(getarduinosheild_Ports(), this.getsheildPorts(), null, "ports", null, 0, 1, arduinosheild.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(sheildPortsEClass, sheildPorts.class, "sheildPorts", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getsheildPorts_Port(), this.getsheildPort(), null, "port", null, 0, -1, sheildPorts.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(sheildPortEClass, sheildPort.class, "sheildPort", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getsheildPort_PinName(), ecorePackage.getEString(), "pinName", null, 0, 1, sheildPort.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
