 ...
 * @generated
 */
public class A653capabletargetPackageImpl extends EPackageImpl implements A653capabletargetPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass superA653CapableTargetTypeEClass = null;
	 ...
	 * @see targets.a653capabletarget.A653capabletargetPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private A653capabletargetPackageImpl() {
		super(eNS_URI, A653capabletargetFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link A653capabletargetPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static A653capabletargetPackage init() {
		if (isInited) return (A653capabletargetPackage)EPackage.Registry.INSTANCE.getEPackage(A653capabletargetPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredA653capabletargetPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		A653capabletargetPackageImpl theA653capabletargetPackage = registeredA653capabletargetPackage instanceof A653capabletargetPackageImpl ? (A653capabletargetPackageImpl)registeredA653capabletargetPackage : new A653capabletargetPackageImpl();
		...
		theA653capabletargetPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(A653capabletargetPackage.eNS_URI, theA653capabletargetPackage);
		return theA653capabletargetPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getSuperA653CapableTargetType() {
		return superA653CapableTargetTypeEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getSuperA653CapableTargetType_OperatingSytem() {
		return (EReference)superA653CapableTargetTypeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getOperatingSystem_Memory() {
	 ...
	 * @generated
	 */
	public EReference getOperatingSystem_Processes() {
	 ...
	 * @generated
	 */
	public A653capabletargetFactory getA653capabletargetFactory() {
		return (A653capabletargetFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		superA653CapableTargetTypeEClass = createEClass(SUPER_A653_CAPABLE_TARGET_TYPE);
		createEReference(superA653CapableTargetTypeEClass, SUPER_A653_CAPABLE_TARGET_TYPE__OPERATING_SYTEM);

		operatingSystemEClass = createEClass(OPERATING_SYSTEM);
		createEReference(operatingSystemEClass, OPERATING_SYSTEM__MEMORY);
		createEReference(operatingSystemEClass, OPERATING_SYSTEM__PROCESSES);
	}
	...
	public void initializePackageContents() {
		...
		superA653CapableTargetTypeEClass.getESuperTypes().add(theEtypesPackage.getSuperIdentifierType());
		superA653CapableTargetTypeEClass.getESuperTypes().add(theEtypesPackage.getSuperTrackingType());
		operatingSystemEClass.getESuperTypes().add(theEtypesPackage.getSuperIdentifierType());
		operatingSystemEClass.getESuperTypes().add(theEtypesPackage.getSuperTrackingType());

		// Initialize classes, features, and operations; add parameters
		initEClass(superA653CapableTargetTypeEClass, SuperA653CapableTargetType.class, "SuperA653CapableTargetType", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSuperA653CapableTargetType_OperatingSytem(), this.getOperatingSystem(), null, "operatingSytem", null, 0, 1, SuperA653CapableTargetType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getOperatingSystem_Memory(), theEtypesPackage.getMemory(), null, "memory", null, 0, 1, OperatingSystem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getOperatingSystem_Processes(), theA653partitionPackage.getProcesses(), null, "processes", null, 0, 1, OperatingSystem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}

} //A653capabletargetPackageImpl
