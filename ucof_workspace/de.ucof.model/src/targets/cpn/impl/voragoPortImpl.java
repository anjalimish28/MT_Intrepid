 ...
 * </p>
 * <ul>
 *   <li>{@link targets.cpn.impl.voragoPortImpl#getPinName <em>Pin Name</em>}</li>
 *   <li>{@link targets.cpn.impl.voragoPortImpl#getPinNumber <em>Pin Number</em>}</li>
 * </ul>
 *
 * @generated
 */
public class voragoPortImpl extends SuperHardwarePortTypeImpl implements voragoPort {
	...
	protected EClass eStaticClass() {
		return CpnPackage.Literals.VORAGO_PORT;
	}
	...
	public void setPinName(String newPinName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpnPackage.VORAGO_PORT__PIN_NAME, oldPinName, pinName));
	}
	...
	public void setPinNumber(int newPinNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpnPackage.VORAGO_PORT__PIN_NUMBER, oldPinNumber, pinNumber));
	}
