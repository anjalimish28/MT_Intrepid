 ...
 * @generated
 */
public class CpnAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected CpnSwitch<Adapter> modelSwitch =
		new CpnSwitch<Adapter>() {
			@Override
			public Adapter caseva41620peb1(va41620peb1 object) {
				return createva41620peb1Adapter();
			}
			@Override
			public Adapter casevoragoPorts(voragoPorts object) {
				return createvoragoPortsAdapter();
			}
			@Override
			public Adapter casevoragoPort(voragoPort object) {
				return createvoragoPortAdapter();
			}
			@Override
			public Adapter caseCanDriverConfig(CanDriverConfig object) {
				return createCanDriverConfigAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link targets.cpn.va41620peb1 <em>va41620peb1</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createva41620peb1Adapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link targets.cpn.voragoPorts <em>vorago Ports</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createvoragoPortsAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link targets.cpn.voragoPort <em>vorago Port</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createvoragoPortAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link targets.cpn.CanDriverConfig <em>Can Driver Config</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCanDriverConfigAdapter() {
		return null;
	}
