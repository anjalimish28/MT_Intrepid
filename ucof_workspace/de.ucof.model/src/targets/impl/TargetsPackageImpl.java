...
public class TargetsPackageImpl extends EPackageImpl implements TargetsPackage {
	 ...
	 * @generated
	 */
	private EClass superTargetTypeEClass = null;
	 ...
	 * @generated
	 */
	private EClass superIOHardwareTypeEClass = null;
	 ...
	 * @generated
	 */
	private EClass superClassExtensionTypeEClass = null;
	 ...
	 * @generated
	 */
	private EClass superAssignmentSpecificationTypeEClass = null;
	 ...
	 * @generated
	 */
	private EClass attributeDatatypeConversionEClass = null;
	 ...
	 * @generated
	 */
	private EClass resistorInfoEClass = null;
	 ...
	 * @generated
	 */
	private EClass superHardwarePortTypeEClass = null;
	 ...
	 * @see targets.TargetsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EClass getSuperTargetType() {
		return superTargetTypeEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getSuperTargetType_ProjectName() {
		return (EAttribute)superTargetTypeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getSuperIOHardwareType() {
		return superIOHardwareTypeEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getSuperIOHardwareType_AssignmentSpecification() {
		return (EReference)superIOHardwareTypeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getSuperClassExtensionType() {
		return superClassExtensionTypeEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getSuperClassExtensionType_ExtendedClassID() {
		return (EAttribute)superClassExtensionTypeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getSuperAssignmentSpecificationType() {
		return superAssignmentSpecificationTypeEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getSuperAssignmentSpecificationType_ReferencedAssignmentID() {
		return (EAttribute)superAssignmentSpecificationTypeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getAttributeDatatypeConversion() {
		return attributeDatatypeConversionEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getAttributeDatatypeConversion_AttributeName() {
		return (EAttribute)attributeDatatypeConversionEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getAttributeDatatypeConversion_TargetDataType() {
		return (EAttribute)attributeDatatypeConversionEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getAttributeDatatypeConversion_ValuePrefix() {
		return (EAttribute)attributeDatatypeConversionEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getAttributeDatatypeConversion_ValuePostfix() {
		return (EAttribute)attributeDatatypeConversionEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EClass getResistorInfo() {
		return resistorInfoEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getResistorInfo_ResistanceOhm() {
		return (EAttribute)resistorInfoEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getResistorInfo_ResistorPartNumber() {
		return (EAttribute)resistorInfoEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getResistorInfo_MountLocation() {
		return (EAttribute)resistorInfoEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getHardwareInformation_HardwareTopologyName() {
	 ...
	 * @generated
	 */
	public EAttribute getHardwareInformation_NameOfHardwareSystem() {
	 ...
	 * @generated
	 */
	public EAttribute getHardwareInformation_IPAddressOfHardwareSystem() {
		return (EAttribute)hardwareInformationEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EClass getSuperHardwarePortType() {
		return superHardwarePortTypeEClass;
	}
	...
	public void createPackageContents() {
		...
		superIOHardwareTypeEClass = createEClass(SUPER_IO_HARDWARE_TYPE);
		createEReference(superIOHardwareTypeEClass, SUPER_IO_HARDWARE_TYPE__ASSIGNMENT_SPECIFICATION);

		superClassExtensionTypeEClass = createEClass(SUPER_CLASS_EXTENSION_TYPE);
		createEAttribute(superClassExtensionTypeEClass, SUPER_CLASS_EXTENSION_TYPE__EXTENDED_CLASS_ID);

		superAssignmentSpecificationTypeEClass = createEClass(SUPER_ASSIGNMENT_SPECIFICATION_TYPE);
		createEAttribute(superAssignmentSpecificationTypeEClass, SUPER_ASSIGNMENT_SPECIFICATION_TYPE__REFERENCED_ASSIGNMENT_ID);

		attributeDatatypeConversionEClass = createEClass(ATTRIBUTE_DATATYPE_CONVERSION);
		createEAttribute(attributeDatatypeConversionEClass, ATTRIBUTE_DATATYPE_CONVERSION__ATTRIBUTE_NAME);
		createEAttribute(attributeDatatypeConversionEClass, ATTRIBUTE_DATATYPE_CONVERSION__TARGET_DATA_TYPE);
		createEAttribute(attributeDatatypeConversionEClass, ATTRIBUTE_DATATYPE_CONVERSION__VALUE_PREFIX);
		createEAttribute(attributeDatatypeConversionEClass, ATTRIBUTE_DATATYPE_CONVERSION__VALUE_POSTFIX);

		resistorInfoEClass = createEClass(RESISTOR_INFO);
		createEAttribute(resistorInfoEClass, RESISTOR_INFO__RESISTANCE_OHM);
		createEAttribute(resistorInfoEClass, RESISTOR_INFO__RESISTOR_PART_NUMBER);
		createEAttribute(resistorInfoEClass, RESISTOR_INFO__MOUNT_LOCATION);

		hardwareInformationEClass = createEClass(HARDWARE_INFORMATION);
		createEAttribute(hardwareInformationEClass, HARDWARE_INFORMATION__HARDWARE_TOPOLOGY_NAME);
		createEAttribute(hardwareInformationEClass, HARDWARE_INFORMATION__NAME_OF_HARDWARE_SYSTEM);
		createEAttribute(hardwareInformationEClass, HARDWARE_INFORMATION__IP_ADDRESS_OF_HARDWARE_SYSTEM);

		superHardwarePortTypeEClass = createEClass(SUPER_HARDWARE_PORT_TYPE);
	}
	...
	public void initializePackageContents() {
		...
		MotorcontrollerPackage theMotorcontrollerPackage = (MotorcontrollerPackage)EPackage.Registry.INSTANCE.getEPackage(MotorcontrollerPackage.eNS_URI);
		...
		CpnPackage theCpnPackage = (CpnPackage)EPackage.Registry.INSTANCE.getEPackage(CpnPackage.eNS_URI);
		...
		targetsEClass.getESuperTypes().add(theEtypesPackage.getSuperIdentifierType());
		targetsEClass.getESuperTypes().add(theEtypesPackage.getSuperTrackingType());
		superTargetTypeEClass.getESuperTypes().add(theEtypesPackage.getSuperIdentifierType());
		superTargetTypeEClass.getESuperTypes().add(theEtypesPackage.getSuperTrackingType());
		superIOHardwareTypeEClass.getESuperTypes().add(theEtypesPackage.getSuperIdentifierType());
		superIOHardwareTypeEClass.getESuperTypes().add(theEtypesPackage.getSuperTrackingType());
		superClassExtensionTypeEClass.getESuperTypes().add(theEtypesPackage.getSuperIdentifierType());
		superClassExtensionTypeEClass.getESuperTypes().add(theEtypesPackage.getSuperTrackingType());
		superAssignmentSpecificationTypeEClass.getESuperTypes().add(theEtypesPackage.getSuperIdentifierType());
		superAssignmentSpecificationTypeEClass.getESuperTypes().add(theEtypesPackage.getSuperTrackingType());
		attributeDatatypeConversionEClass.getESuperTypes().add(this.getSuperAssignmentSpecificationType());
		resistorInfoEClass.getESuperTypes().add(this.getSuperAssignmentSpecificationType());
		superHardwarePortTypeEClass.getESuperTypes().add(theEtypesPackage.getSuperIdentifierType());
		superHardwarePortTypeEClass.getESuperTypes().add(theEtypesPackage.getSuperTrackingType());
		...
		initEClass(superIOHardwareTypeEClass, SuperIOHardwareType.class, "SuperIOHardwareType", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSuperIOHardwareType_AssignmentSpecification(), this.getSuperAssignmentSpecificationType(), null, "assignmentSpecification", null, 0, -1, SuperIOHardwareType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(superClassExtensionTypeEClass, SuperClassExtensionType.class, "SuperClassExtensionType", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSuperClassExtensionType_ExtendedClassID(), theEdataPackage.getUUIDType(), "extendedClassID", null, 0, 1, SuperClassExtensionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(superAssignmentSpecificationTypeEClass, SuperAssignmentSpecificationType.class, "SuperAssignmentSpecificationType", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSuperAssignmentSpecificationType_ReferencedAssignmentID(), theEdataPackage.getUUIDType(), "referencedAssignmentID", null, 0, 1, SuperAssignmentSpecificationType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(attributeDatatypeConversionEClass, AttributeDatatypeConversion.class, "AttributeDatatypeConversion", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getAttributeDatatypeConversion_AttributeName(), ecorePackage.getEString(), "attributeName", null, 0, 1, AttributeDatatypeConversion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAttributeDatatypeConversion_TargetDataType(), theEnumsPackage.getTargetDataType(), "targetDataType", null, 0, 1, AttributeDatatypeConversion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAttributeDatatypeConversion_ValuePrefix(), ecorePackage.getEString(), "valuePrefix", null, 0, 1, AttributeDatatypeConversion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAttributeDatatypeConversion_ValuePostfix(), ecorePackage.getEString(), "valuePostfix", null, 0, 1, AttributeDatatypeConversion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(resistorInfoEClass, ResistorInfo.class, "ResistorInfo", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getResistorInfo_ResistanceOhm(), ecorePackage.getEInt(), "resistanceOhm", null, 0, 1, ResistorInfo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResistorInfo_ResistorPartNumber(), ecorePackage.getEString(), "resistorPartNumber", null, 0, 1, ResistorInfo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResistorInfo_MountLocation(), ecorePackage.getEString(), "mountLocation", null, 0, 1, ResistorInfo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getHardwareInformation_HardwareTopologyName(), ecorePackage.getEString(), "hardwareTopologyName", null, 0, 1, HardwareInformation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getHardwareInformation_NameOfHardwareSystem(), ecorePackage.getEString(), "nameOfHardwareSystem", null, 0, 1, HardwareInformation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getHardwareInformation_IPAddressOfHardwareSystem(), ecorePackage.getEString(), "iPAddressOfHardwareSystem", null, 0, 1, HardwareInformation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(superHardwarePortTypeEClass, SuperHardwarePortType.class, "SuperHardwarePortType", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
