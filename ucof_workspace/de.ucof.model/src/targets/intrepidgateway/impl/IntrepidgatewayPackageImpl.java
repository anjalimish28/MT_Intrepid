 ...
 * @generated
 */
public class IntrepidgatewayPackageImpl extends EPackageImpl implements IntrepidgatewayPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass msgBoxExtensionEClass = null;
	 ...
	 * @generated
	 */
	private EClass canMailboxAddressFilterEClass = null;
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass canMailboxOutSlotEClass = null;
	 ...
	 * @see targets.intrepidgateway.IntrepidgatewayPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private IntrepidgatewayPackageImpl() {
		super(eNS_URI, IntrepidgatewayFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link IntrepidgatewayPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static IntrepidgatewayPackage init() {
		if (isInited) return (IntrepidgatewayPackage)EPackage.Registry.INSTANCE.getEPackage(IntrepidgatewayPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredIntrepidgatewayPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		IntrepidgatewayPackageImpl theIntrepidgatewayPackage = registeredIntrepidgatewayPackage instanceof IntrepidgatewayPackageImpl ? (IntrepidgatewayPackageImpl)registeredIntrepidgatewayPackage : new IntrepidgatewayPackageImpl();
		...
		theIntrepidgatewayPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(IntrepidgatewayPackage.eNS_URI, theIntrepidgatewayPackage);
		return theIntrepidgatewayPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getMsgBoxExtension() {
		return msgBoxExtensionEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getMsgBoxExtension_NumOfOutgoingMailboxes() {
		return (EAttribute)msgBoxExtensionEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getMsgBoxExtension_NumOfIncomingMailboxes() {
		return (EAttribute)msgBoxExtensionEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getMsgBoxExtension_SmallBufferSize() {
		return (EAttribute)msgBoxExtensionEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getMsgBoxExtension_SmallBufferCount() {
		return (EAttribute)msgBoxExtensionEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EAttribute getMsgBoxExtension_MediumBufferSize() {
		return (EAttribute)msgBoxExtensionEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EAttribute getMsgBoxExtension_MediumBufferCount() {
		return (EAttribute)msgBoxExtensionEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EAttribute getMsgBoxExtension_BigBufferSize() {
		return (EAttribute)msgBoxExtensionEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 * @generated
	 */
	public EAttribute getMsgBoxExtension_BigBufferCount() {
		return (EAttribute)msgBoxExtensionEClass.getEStructuralFeatures().get(7);
	}
	 ...
	 * @generated
	 */
	public EAttribute getMsgBoxExtension_NodeAddr() {
		return (EAttribute)msgBoxExtensionEClass.getEStructuralFeatures().get(8);
	}
	 ...
	 * @generated
	 */
	public EAttribute getMsgBoxExtension_NodeAddressSymbol() {
		return (EAttribute)msgBoxExtensionEClass.getEStructuralFeatures().get(9);
	}
	 ...
	 * @generated
	 */
	public EReference getMsgBoxExtension_IncomingDestinationFilter() {
		return (EReference)msgBoxExtensionEClass.getEStructuralFeatures().get(10);
	}
	 ...
	 * @generated
	 */
	public EReference getMsgBoxExtension_SenderSourceFilter() {
		return (EReference)msgBoxExtensionEClass.getEStructuralFeatures().get(11);
	}
	 ...
	 * @generated
	 */
	public EReference getMsgBoxExtension_OutgoingMailboxSlot() {
		return (EReference)msgBoxExtensionEClass.getEStructuralFeatures().get(12);
	}
	 ...
	 * @generated
	 */
	public EClass getCanMailboxAddressFilter() {
		return canMailboxAddressFilterEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getCanMailboxAddressFilter_AddressSymbol() {
		return (EAttribute)canMailboxAddressFilterEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getCanMailboxAddressFilter_AddressValue() {
		return (EAttribute)canMailboxAddressFilterEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EClass getCanMailboxOutSlot() {
		return canMailboxOutSlotEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getCanMailboxOutSlot_PortId() {
		return (EAttribute)canMailboxOutSlotEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getCanMailboxOutSlot_SourceAddressSymbol() {
		return (EAttribute)canMailboxOutSlotEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getCanMailboxOutSlot_SourceAddressValue() {
		return (EAttribute)canMailboxOutSlotEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getCanMailboxOutSlot_DestinationAddressSymbol() {
		return (EAttribute)canMailboxOutSlotEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EAttribute getCanMailboxOutSlot_DestinationAddressValue() {
		return (EAttribute)canMailboxOutSlotEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EAttribute getCanMailboxOutSlot_Multicast() {
		return (EAttribute)canMailboxOutSlotEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public IntrepidgatewayFactory getIntrepidgatewayFactory() {
		return (IntrepidgatewayFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		msgBoxExtensionEClass = createEClass(MSG_BOX_EXTENSION);
		createEAttribute(msgBoxExtensionEClass, MSG_BOX_EXTENSION__NUM_OF_OUTGOING_MAILBOXES);
		createEAttribute(msgBoxExtensionEClass, MSG_BOX_EXTENSION__NUM_OF_INCOMING_MAILBOXES);
		createEAttribute(msgBoxExtensionEClass, MSG_BOX_EXTENSION__SMALL_BUFFER_SIZE);
		createEAttribute(msgBoxExtensionEClass, MSG_BOX_EXTENSION__SMALL_BUFFER_COUNT);
		createEAttribute(msgBoxExtensionEClass, MSG_BOX_EXTENSION__MEDIUM_BUFFER_SIZE);
		createEAttribute(msgBoxExtensionEClass, MSG_BOX_EXTENSION__MEDIUM_BUFFER_COUNT);
		createEAttribute(msgBoxExtensionEClass, MSG_BOX_EXTENSION__BIG_BUFFER_SIZE);
		createEAttribute(msgBoxExtensionEClass, MSG_BOX_EXTENSION__BIG_BUFFER_COUNT);
		createEAttribute(msgBoxExtensionEClass, MSG_BOX_EXTENSION__NODE_ADDR);
		createEAttribute(msgBoxExtensionEClass, MSG_BOX_EXTENSION__NODE_ADDRESS_SYMBOL);
		createEReference(msgBoxExtensionEClass, MSG_BOX_EXTENSION__INCOMING_DESTINATION_FILTER);
		createEReference(msgBoxExtensionEClass, MSG_BOX_EXTENSION__SENDER_SOURCE_FILTER);
		createEReference(msgBoxExtensionEClass, MSG_BOX_EXTENSION__OUTGOING_MAILBOX_SLOT);

		canMailboxAddressFilterEClass = createEClass(CAN_MAILBOX_ADDRESS_FILTER);
		createEAttribute(canMailboxAddressFilterEClass, CAN_MAILBOX_ADDRESS_FILTER__ADDRESS_SYMBOL);
		createEAttribute(canMailboxAddressFilterEClass, CAN_MAILBOX_ADDRESS_FILTER__ADDRESS_VALUE);

		canMailboxOutSlotEClass = createEClass(CAN_MAILBOX_OUT_SLOT);
		createEAttribute(canMailboxOutSlotEClass, CAN_MAILBOX_OUT_SLOT__PORT_ID);
		createEAttribute(canMailboxOutSlotEClass, CAN_MAILBOX_OUT_SLOT__SOURCE_ADDRESS_SYMBOL);
		createEAttribute(canMailboxOutSlotEClass, CAN_MAILBOX_OUT_SLOT__SOURCE_ADDRESS_VALUE);
		createEAttribute(canMailboxOutSlotEClass, CAN_MAILBOX_OUT_SLOT__DESTINATION_ADDRESS_SYMBOL);
		createEAttribute(canMailboxOutSlotEClass, CAN_MAILBOX_OUT_SLOT__DESTINATION_ADDRESS_VALUE);
		createEAttribute(canMailboxOutSlotEClass, CAN_MAILBOX_OUT_SLOT__MULTICAST);
	}
	...
	public void initializePackageContents() {
		...
		msgBoxExtensionEClass.getESuperTypes().add(theTargetsPackage.getSuperClassExtensionType());
		canMailboxAddressFilterEClass.getESuperTypes().add(theEtypesPackage.getSuperIdentifierType());
		canMailboxAddressFilterEClass.getESuperTypes().add(theEtypesPackage.getSuperTrackingType());
		canMailboxOutSlotEClass.getESuperTypes().add(theEtypesPackage.getSuperIdentifierType());
		canMailboxOutSlotEClass.getESuperTypes().add(theEtypesPackage.getSuperTrackingType());

		// Initialize classes, features, and operations; add parameters
		initEClass(msgBoxExtensionEClass, MsgBoxExtension.class, "MsgBoxExtension", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getMsgBoxExtension_NumOfOutgoingMailboxes(), ecorePackage.getEInt(), "numOfOutgoingMailboxes", null, 0, 1, MsgBoxExtension.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMsgBoxExtension_NumOfIncomingMailboxes(), ecorePackage.getEInt(), "numOfIncomingMailboxes", null, 0, 1, MsgBoxExtension.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMsgBoxExtension_SmallBufferSize(), ecorePackage.getEInt(), "smallBufferSize", null, 0, 1, MsgBoxExtension.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMsgBoxExtension_SmallBufferCount(), ecorePackage.getEInt(), "smallBufferCount", null, 0, 1, MsgBoxExtension.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMsgBoxExtension_MediumBufferSize(), ecorePackage.getEInt(), "mediumBufferSize", null, 0, 1, MsgBoxExtension.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMsgBoxExtension_MediumBufferCount(), ecorePackage.getEInt(), "mediumBufferCount", null, 0, 1, MsgBoxExtension.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMsgBoxExtension_BigBufferSize(), ecorePackage.getEInt(), "bigBufferSize", null, 0, 1, MsgBoxExtension.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMsgBoxExtension_BigBufferCount(), ecorePackage.getEInt(), "bigBufferCount", null, 0, 1, MsgBoxExtension.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMsgBoxExtension_NodeAddr(), ecorePackage.getEInt(), "nodeAddr", null, 0, 1, MsgBoxExtension.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMsgBoxExtension_NodeAddressSymbol(), ecorePackage.getEString(), "nodeAddressSymbol", null, 0, 1, MsgBoxExtension.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMsgBoxExtension_IncomingDestinationFilter(), this.getCanMailboxAddressFilter(), null, "incomingDestinationFilter", null, 0, -1, MsgBoxExtension.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMsgBoxExtension_SenderSourceFilter(), this.getCanMailboxAddressFilter(), null, "senderSourceFilter", null, 0, -1, MsgBoxExtension.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMsgBoxExtension_OutgoingMailboxSlot(), this.getCanMailboxOutSlot(), null, "outgoingMailboxSlot", null, 0, -1, MsgBoxExtension.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(canMailboxAddressFilterEClass, CanMailboxAddressFilter.class, "CanMailboxAddressFilter", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCanMailboxAddressFilter_AddressSymbol(), ecorePackage.getEString(), "addressSymbol", null, 0, 1, CanMailboxAddressFilter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCanMailboxAddressFilter_AddressValue(), ecorePackage.getEInt(), "addressValue", null, 0, 1, CanMailboxAddressFilter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(canMailboxOutSlotEClass, CanMailboxOutSlot.class, "CanMailboxOutSlot", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCanMailboxOutSlot_PortId(), ecorePackage.getEString(), "portId", null, 0, 1, CanMailboxOutSlot.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCanMailboxOutSlot_SourceAddressSymbol(), ecorePackage.getEString(), "sourceAddressSymbol", null, 0, 1, CanMailboxOutSlot.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCanMailboxOutSlot_SourceAddressValue(), ecorePackage.getEInt(), "sourceAddressValue", null, 0, 1, CanMailboxOutSlot.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCanMailboxOutSlot_DestinationAddressSymbol(), ecorePackage.getEString(), "destinationAddressSymbol", null, 0, 1, CanMailboxOutSlot.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCanMailboxOutSlot_DestinationAddressValue(), ecorePackage.getEInt(), "destinationAddressValue", null, 0, 1, CanMailboxOutSlot.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCanMailboxOutSlot_Multicast(), ecorePackage.getEBoolean(), "multicast", null, 0, 1, CanMailboxOutSlot.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}

} //IntrepidgatewayPackageImpl
