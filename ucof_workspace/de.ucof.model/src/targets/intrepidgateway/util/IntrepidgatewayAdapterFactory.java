/**
 */
package targets.intrepidgateway.util;
 ...
 * @generated
 */
public class IntrepidgatewayAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected static IntrepidgatewayPackage modelPackage;
	 ...
	 * @generated
	 */
	public IntrepidgatewayAdapterFactory() {
		if (modelPackage == null) {
			modelPackage = IntrepidgatewayPackage.eINSTANCE;
		}
	}
	 ...
	 * @generated
	 */
	protected IntrepidgatewaySwitch<Adapter> modelSwitch =
		new IntrepidgatewaySwitch<Adapter>() {
			@Override
			public Adapter caseMsgBoxExtension(MsgBoxExtension object) {
				return createMsgBoxExtensionAdapter();
			}
			@Override
			public Adapter caseCanMailboxAddressFilter(CanMailboxAddressFilter object) {
				return createCanMailboxAddressFilterAdapter();
			}
			@Override
			public Adapter caseCanMailboxOutSlot(CanMailboxOutSlot object) {
				return createCanMailboxOutSlotAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link targets.intrepidgateway.MsgBoxExtension <em>Msg Box Extension</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createMsgBoxExtensionAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link targets.intrepidgateway.CanMailboxAddressFilter <em>Can Mailbox Address Filter</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCanMailboxAddressFilterAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link targets.intrepidgateway.CanMailboxOutSlot <em>Can Mailbox Out Slot</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCanMailboxOutSlotAdapter() {
		return null;
	}
