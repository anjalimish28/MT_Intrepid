 ...
 * @generated
 */
public class MatlabPackageImpl extends EPackageImpl implements MatlabPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass simulinkProjectEClass = null;
	 ...
	 * @generated
	 */
	private EClass simulinkBlockEClass = null;
	 ...
	 * @see targets.matlab.MatlabPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private MatlabPackageImpl() {
		super(eNS_URI, MatlabFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link MatlabPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static MatlabPackage init() {
		if (isInited) return (MatlabPackage)EPackage.Registry.INSTANCE.getEPackage(MatlabPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredMatlabPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		MatlabPackageImpl theMatlabPackage = registeredMatlabPackage instanceof MatlabPackageImpl ? (MatlabPackageImpl)registeredMatlabPackage : new MatlabPackageImpl();
		...
		theMatlabPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(MatlabPackage.eNS_URI, theMatlabPackage);
		return theMatlabPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getSimulinkProject() {
		return simulinkProjectEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getSimulinkProject_SimulinkBlock() {
		return (EReference)simulinkProjectEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getSimulinkProject_SimulinkLibrary() {
		return (EReference)simulinkProjectEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getSimulinkProject_SampleTime() {
		return (EAttribute)simulinkProjectEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EClass getSimulinkBlock() {
		return simulinkBlockEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getSimulinkBlock_LibraryLink() {
		return (EAttribute)simulinkBlockEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getSimulinkLibrary_LibraryLink() {
		return (EAttribute)simulinkLibraryEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public MatlabFactory getMatlabFactory() {
		return (MatlabFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		simulinkProjectEClass = createEClass(SIMULINK_PROJECT);
		createEReference(simulinkProjectEClass, SIMULINK_PROJECT__SIMULINK_BLOCK);
		createEReference(simulinkProjectEClass, SIMULINK_PROJECT__SIMULINK_LIBRARY);
		createEAttribute(simulinkProjectEClass, SIMULINK_PROJECT__SAMPLE_TIME);

		simulinkBlockEClass = createEClass(SIMULINK_BLOCK);
		createEAttribute(simulinkBlockEClass, SIMULINK_BLOCK__LIBRARY_LINK);

		simulinkLibraryEClass = createEClass(SIMULINK_LIBRARY);
		createEAttribute(simulinkLibraryEClass, SIMULINK_LIBRARY__LIBRARY_LINK);
	}
	...
	public void initializePackageContents() {
		...
		simulinkProjectEClass.getESuperTypes().add(theTargetsPackage.getSuperTargetType());
		simulinkBlockEClass.getESuperTypes().add(theEtypesPackage.getSuperIdentifierType());
		simulinkBlockEClass.getESuperTypes().add(theEtypesPackage.getSuperTrackingType());
		simulinkLibraryEClass.getESuperTypes().add(theEtypesPackage.getSuperIdentifierType());
		simulinkLibraryEClass.getESuperTypes().add(theEtypesPackage.getSuperTrackingType());

		// Initialize classes, features, and operations; add parameters
		initEClass(simulinkProjectEClass, SimulinkProject.class, "SimulinkProject", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSimulinkProject_SimulinkBlock(), this.getSimulinkBlock(), null, "simulinkBlock", null, 0, -1, SimulinkProject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSimulinkProject_SimulinkLibrary(), this.getSimulinkLibrary(), null, "simulinkLibrary", null, 0, 1, SimulinkProject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSimulinkProject_SampleTime(), ecorePackage.getEFloat(), "sampleTime", null, 0, 1, SimulinkProject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(simulinkBlockEClass, SimulinkBlock.class, "SimulinkBlock", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSimulinkBlock_LibraryLink(), ecorePackage.getEString(), "libraryLink", null, 0, 1, SimulinkBlock.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getSimulinkLibrary_LibraryLink(), ecorePackage.getEString(), "libraryLink", null, 0, 1, SimulinkLibrary.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
