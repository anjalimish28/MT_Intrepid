 ...
 * </p>
 * <ul>
 *   <li>{@link ucof.common.etypes.QueuingPort#getMaxNumberOfMessages <em>Max Number Of Messages</em>}</li>
 * </ul>
 *
 * @see ucof.common.etypes.EtypesPackage#getQueuingPort()
 * @model
 * @generated
 */
public interface QueuingPort extends SuperInterCommunicationPortType {
	 ...
	 * @see ucof.common.etypes.EtypesPackage#getQueuingPort_MaxNumberOfMessages()
	...
	/**
	 * Sets the value of the '{@link ucof.common.etypes.QueuingPort#getMaxNumberOfMessages <em>Max Number Of Messages</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
