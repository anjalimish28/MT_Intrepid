 ...
 * @generated
 */
public class Arinc429AdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected Arinc429Switch<Adapter> modelSwitch =
		new Arinc429Switch<Adapter>() {
			@Override
			public Adapter caseA429Bus(A429Bus object) {
				return createA429BusAdapter();
			}
			@Override
			public Adapter caseA429Message(A429Message object) {
				return createA429MessageAdapter();
			}
			@Override
			public Adapter caseA429SignalSpecification(A429SignalSpecification object) {
				return createA429SignalSpecificationAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link ucof.communication.arinc429.A429Bus <em>A429 Bus</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createA429BusAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link ucof.communication.arinc429.A429Message <em>A429 Message</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createA429MessageAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link ucof.communication.arinc429.A429SignalSpecification <em>A429 Signal Specification</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createA429SignalSpecificationAdapter() {
		return null;
	}
