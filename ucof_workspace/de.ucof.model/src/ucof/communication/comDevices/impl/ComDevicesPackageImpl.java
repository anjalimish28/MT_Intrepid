...
import ucof.communication.comDevices.ED247Gateway;
import ucof.communication.comDevices.GenericGateway;
 ...
 * @generated
 */
public class ComDevicesPackageImpl extends EPackageImpl implements ComDevicesPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass communicationDevicesEClass = null;
	 ...
	 * @generated
	 */
	private EClass superCommunicationDeviceTypeEClass = null;
	 ...
	 * @generated
	 */
	private EClass ed247GatewayEClass = null;
	 ...
	 * @generated
	 */
	private EClass genericGatewayEClass = null;
	 ...
	 * @see ucof.communication.comDevices.ComDevicesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ComDevicesPackageImpl() {
		super(eNS_URI, ComDevicesFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link ComDevicesPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ComDevicesPackage init() {
		if (isInited) return (ComDevicesPackage)EPackage.Registry.INSTANCE.getEPackage(ComDevicesPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredComDevicesPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		ComDevicesPackageImpl theComDevicesPackage = registeredComDevicesPackage instanceof ComDevicesPackageImpl ? (ComDevicesPackageImpl)registeredComDevicesPackage : new ComDevicesPackageImpl();
		...
		theComDevicesPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ComDevicesPackage.eNS_URI, theComDevicesPackage);
		return theComDevicesPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getCommunicationDevices() {
		return communicationDevicesEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getCommunicationDevices_CommunicationDevice() {
		return (EReference)communicationDevicesEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getSuperCommunicationDeviceType() {
		return superCommunicationDeviceTypeEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getED247Gateway() {
		return ed247GatewayEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getGenericGateway() {
		return genericGatewayEClass;
	}
	 ...
	 * @generated
	 */
	public ComDevicesFactory getComDevicesFactory() {
		return (ComDevicesFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		communicationDevicesEClass = createEClass(COMMUNICATION_DEVICES);
		createEReference(communicationDevicesEClass, COMMUNICATION_DEVICES__COMMUNICATION_DEVICE);

		superCommunicationDeviceTypeEClass = createEClass(SUPER_COMMUNICATION_DEVICE_TYPE);

		ed247GatewayEClass = createEClass(ED247_GATEWAY);

		genericGatewayEClass = createEClass(GENERIC_GATEWAY);
	}
	...
	public void initializePackageContents() {
		...
		communicationDevicesEClass.getESuperTypes().add(theEtypesPackage.getSuperSetType());
		superCommunicationDeviceTypeEClass.getESuperTypes().add(theEtypesPackage.getSuperDeviceType());
		ed247GatewayEClass.getESuperTypes().add(this.getSuperCommunicationDeviceType());
		genericGatewayEClass.getESuperTypes().add(this.getSuperCommunicationDeviceType());

		// Initialize classes, features, and operations; add parameters
		initEClass(communicationDevicesEClass, CommunicationDevices.class, "CommunicationDevices", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCommunicationDevices_CommunicationDevice(), this.getSuperCommunicationDeviceType(), null, "communicationDevice", null, 0, -1, CommunicationDevices.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(superCommunicationDeviceTypeEClass, SuperCommunicationDeviceType.class, "SuperCommunicationDeviceType", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(ed247GatewayEClass, ED247Gateway.class, "ED247Gateway", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(genericGatewayEClass, GenericGateway.class, "GenericGateway", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
	}

} //ComDevicesPackageImpl
