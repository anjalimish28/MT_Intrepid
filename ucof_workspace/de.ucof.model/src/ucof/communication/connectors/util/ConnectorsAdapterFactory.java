...
public class ConnectorsAdapterFactory extends AdapterFactoryImpl {
	...
	protected ConnectorsSwitch<Adapter> modelSwitch =
		new ConnectorsSwitch<Adapter>() {
			...
			@Override
			public Adapter caseConnectorGroup(ConnectorGroup object) {
				return createConnectorGroupAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseConnectionPin(ConnectionPin object) {
				return createConnectionPinAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link ucof.communication.connectors.Connectors <em>Connectors</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link ucof.communication.connectors.ConnectorGroup <em>Connector Group</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createConnectorGroupAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link ucof.communication.connectors.Connector <em>Connector</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link ucof.communication.connectors.ConnectionPin <em>Connection Pin</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createConnectionPinAdapter() {
		return null;
	}
