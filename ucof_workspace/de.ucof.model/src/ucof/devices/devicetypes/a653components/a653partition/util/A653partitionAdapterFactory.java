/**
 */
package ucof.devices.devicetypes.a653components.a653partition.util;
 ...
 * @generated
 */
public class A653partitionAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected static A653partitionPackage modelPackage;
	 ...
	 * @generated
	 */
	public A653partitionAdapterFactory() {
		if (modelPackage == null) {
			modelPackage = A653partitionPackage.eINSTANCE;
		}
	}
	 ...
	 * @generated
	 */
	protected A653partitionSwitch<Adapter> modelSwitch =
		new A653partitionSwitch<Adapter>() {
			@Override
			public Adapter caseModulePartitions(ModulePartitions object) {
				return createModulePartitionsAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseProcesses(Processes object) {
				return createProcessesAdapter();
			}
			@Override
			public Adapter caseProcess(ucof.devices.devicetypes.a653components.a653partition.Process object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link ucof.devices.devicetypes.a653components.a653partition.ModulePartitions <em>Module Partitions</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createModulePartitionsAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link ucof.devices.devicetypes.a653components.a653partition.Partition <em>Partition</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link ucof.devices.devicetypes.a653components.a653partition.Processes <em>Processes</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createProcessesAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link ucof.devices.devicetypes.a653components.a653partition.Process <em>Process</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
