...
import ucof.devices.functions.FunctionsFactory;
...
public class FunctionsPackageImpl extends EPackageImpl implements FunctionsPackage {
	 ...
	 * @generated
	 */
	private EClass deviceFunctionsEClass = null;
	 ...
	 * @generated
	 */
	private EClass superFunctionTypeEClass = null;
	 ...
	 * @see ucof.devices.functions.FunctionsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EClass getDeviceFunctions() {
		return deviceFunctionsEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getDeviceFunctions_Function() {
		return (EReference)deviceFunctionsEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getFunctionLink_FunctionFile() {
		return (EAttribute)functionLinkEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getSuperFunctionType() {
		return superFunctionTypeEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getSuperFunctionType_FunctionLink() {
		return (EReference)superFunctionTypeEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		deviceFunctionsEClass = createEClass(DEVICE_FUNCTIONS);
		createEReference(deviceFunctionsEClass, DEVICE_FUNCTIONS__FUNCTION);

		functionLinkEClass = createEClass(FUNCTION_LINK);
		createEAttribute(functionLinkEClass, FUNCTION_LINK__FUNCTION_FILE);

		superFunctionTypeEClass = createEClass(SUPER_FUNCTION_TYPE);
		createEReference(superFunctionTypeEClass, SUPER_FUNCTION_TYPE__FUNCTION_LINK);
	}
	...
	public void initializePackageContents() {
		...
		RoutingPackage theRoutingPackage = (RoutingPackage)EPackage.Registry.INSTANCE.getEPackage(RoutingPackage.eNS_URI);
		EtypesPackage theEtypesPackage = (EtypesPackage)EPackage.Registry.INSTANCE.getEPackage(EtypesPackage.eNS_URI);

		// Add subpackages
		getESubpackages().add(theRoutingPackage);
		...
		deviceFunctionsEClass.getESuperTypes().add(theEtypesPackage.getSuperIdentifierType());
		deviceFunctionsEClass.getESuperTypes().add(theEtypesPackage.getSuperTrackingType());
		functionLinkEClass.getESuperTypes().add(theEtypesPackage.getSuperIdentifierType());
		functionLinkEClass.getESuperTypes().add(theEtypesPackage.getSuperTrackingType());
		superFunctionTypeEClass.getESuperTypes().add(theEtypesPackage.getSuperIdentifierType());
		superFunctionTypeEClass.getESuperTypes().add(theEtypesPackage.getSuperTrackingType());

		// Initialize classes, features, and operations; add parameters
		initEClass(deviceFunctionsEClass, DeviceFunctions.class, "DeviceFunctions", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getDeviceFunctions_Function(), this.getSuperFunctionType(), null, "function", null, 0, -1, DeviceFunctions.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(functionLinkEClass, FunctionLink.class, "FunctionLink", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getFunctionLink_FunctionFile(), ecorePackage.getEString(), "functionFile", null, 0, 1, FunctionLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(superFunctionTypeEClass, SuperFunctionType.class, "SuperFunctionType", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSuperFunctionType_FunctionLink(), this.getFunctionLink(), null, "functionLink", null, 0, 1, SuperFunctionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
