...
public class RoutingAdapterFactory extends AdapterFactoryImpl {
	...
	protected RoutingSwitch<Adapter> modelSwitch =
		new RoutingSwitch<Adapter>() {
			...
			@Override
			public Adapter casePayloadRouting(PayloadRouting object) {
				return createPayloadRoutingAdapter();
			}
			@Override
			public Adapter caseSignalRouting(SignalRouting object) {
				return createSignalRoutingAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseSuperFunctionType(SuperFunctionType object) {
				return createSuperFunctionTypeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link ucof.devices.functions.routing.Routing <em>Routing</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link ucof.devices.functions.routing.PayloadRouting <em>Payload Routing</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createPayloadRoutingAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link ucof.devices.functions.routing.SignalRouting <em>Signal Routing</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createSignalRoutingAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link ucof.devices.functions.SuperFunctionType <em>Super Function Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createSuperFunctionTypeAdapter() {
		return null;
	}
