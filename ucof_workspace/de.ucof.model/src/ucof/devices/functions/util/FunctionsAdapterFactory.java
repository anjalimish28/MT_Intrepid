...
public class FunctionsAdapterFactory extends AdapterFactoryImpl {
	...
	protected FunctionsSwitch<Adapter> modelSwitch =
		new FunctionsSwitch<Adapter>() {
			@Override
			public Adapter caseDeviceFunctions(DeviceFunctions object) {
				return createDeviceFunctionsAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link ucof.devices.functions.DeviceFunctions <em>Device Functions</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link ucof.devices.functions.FunctionLink <em>Function Link</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
