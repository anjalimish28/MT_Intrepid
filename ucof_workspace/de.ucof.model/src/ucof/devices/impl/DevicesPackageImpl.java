...
import ucof.devices.DevicesFactory;
...
public class DevicesPackageImpl extends EPackageImpl implements DevicesPackage {
	 ...
	 * @generated
	 */
	private EClass superPlatformDeviceTypeEClass = null;
	 ...
	 * @see ucof.devices.DevicesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EClass getSuperPlatformDeviceType() {
		return superPlatformDeviceTypeEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getSuperPlatformDeviceType_DeviceFunctions() {
		return (EReference)superPlatformDeviceTypeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getSuperPlatformDeviceType_ImplementationType() {
		return (EAttribute)superPlatformDeviceTypeEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		superPlatformDeviceTypeEClass = createEClass(SUPER_PLATFORM_DEVICE_TYPE);
		createEReference(superPlatformDeviceTypeEClass, SUPER_PLATFORM_DEVICE_TYPE__DEVICE_FUNCTIONS);
		createEAttribute(superPlatformDeviceTypeEClass, SUPER_PLATFORM_DEVICE_TYPE__IMPLEMENTATION_TYPE);
	}
	...
	public void initializePackageContents() {
		...
		DevicetypesPackage theDevicetypesPackage = (DevicetypesPackage)EPackage.Registry.INSTANCE.getEPackage(DevicetypesPackage.eNS_URI);
		...
		// Add subpackages
		getESubpackages().add(theDevicetypesPackage);
		getESubpackages().add(theFunctionsPackage);
		getESubpackages().add(thePortsPackage);
		...
		devicesEClass.getESuperTypes().add(theEtypesPackage.getSuperTrackingType());
		devicesEClass.getESuperTypes().add(theEtypesPackage.getSuperIdentifierType());
		superPlatformDeviceTypeEClass.getESuperTypes().add(theEtypesPackage.getSuperDeviceType());

		// Initialize classes, features, and operations; add parameters
		initEClass(devicesEClass, Devices.class, "Devices", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getDevices_Device(), this.getSuperPlatformDeviceType(), null, "device", null, 0, -1, Devices.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(superPlatformDeviceTypeEClass, SuperPlatformDeviceType.class, "SuperPlatformDeviceType", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSuperPlatformDeviceType_DeviceFunctions(), theFunctionsPackage.getDeviceFunctions(), null, "deviceFunctions", null, 0, 1, SuperPlatformDeviceType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSuperPlatformDeviceType_ImplementationType(), theEnumsPackage.getImplementationType(), "implementationType", null, 0, 1, SuperPlatformDeviceType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
