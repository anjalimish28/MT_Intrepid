 ...
 * <!-- end-user-doc -->
 * @see ucof.devices.DevicesPackage
 * @generated
 */
public class DevicesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DevicesPackage.DEVICES: {
				Devices devices = (Devices)theEObject;
				T result = caseDevices(devices);
				if (result == null) result = caseSuperTrackingType(devices);
				if (result == null) result = caseSuperIdentifierType(devices);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DevicesPackage.SUPER_PLATFORM_DEVICE_TYPE: {
				SuperPlatformDeviceType superPlatformDeviceType = (SuperPlatformDeviceType)theEObject;
				T result = caseSuperPlatformDeviceType(superPlatformDeviceType);
				if (result == null) result = caseSuperDeviceType(superPlatformDeviceType);
				if (result == null) result = caseSuperIdentifierType(superPlatformDeviceType);
				if (result == null) result = caseSuperTrackingType(superPlatformDeviceType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
