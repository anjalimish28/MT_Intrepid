 ...
 * @generated
 */
public class UcofPackageImpl extends EPackageImpl implements UcofPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see ucof.UcofPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private UcofPackageImpl() {
		super(eNS_URI, UcofFactory.eINSTANCE);
	}
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *
	 * <p>This method is used to initialize {@link UcofPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static UcofPackage init() {
		if (isInited) return (UcofPackage)EPackage.Registry.INSTANCE.getEPackage(UcofPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredUcofPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		UcofPackageImpl theUcofPackage = registeredUcofPackage instanceof UcofPackageImpl ? (UcofPackageImpl)registeredUcofPackage : new UcofPackageImpl();
		...
		theUcofPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(UcofPackage.eNS_URI, theUcofPackage);
		return theUcofPackage;
	}
	 ...
	 * @generated
	 */
	public EReference getPlatform_Devices() {
	 ...
	 * @generated
	 */
	public EReference getPlatform_Communication() {
	 ...
	 * @generated
	 */
	public EReference getPlatform_Assignments() {
	 ...
	 * @generated
	 */
	public UcofFactory getUcofFactory() {
		return (UcofFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(platformEClass, PLATFORM__DEVICES);
		createEReference(platformEClass, PLATFORM__COMMUNICATION);
		createEReference(platformEClass, PLATFORM__ASSIGNMENTS);
	...
	public void initializePackageContents() {
		...
		getESubpackages().add(theEtypesPackage);
		getESubpackages().add(theEdataPackage);
		getESubpackages().add(theDevicesPackage);
		getESubpackages().add(theCommunicationPackage);
		getESubpackages().add(theAssignmentsPackage);
		...
		platformEClass.getESuperTypes().add(theEtypesPackage.getSuperIdentifierType());
		platformEClass.getESuperTypes().add(theEtypesPackage.getSuperTrackingType());

		// Initialize classes, features, and operations; add parameters
		initEClass(platformEClass, Platform.class, "Platform", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPlatform_Devices(), theDevicesPackage.getDevices(), null, "devices", null, 0, 1, Platform.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPlatform_Communication(), theCommunicationPackage.getCommunication(), null, "communication", null, 0, 1, Platform.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPlatform_Assignments(), theAssignmentsPackage.getAssignments(), null, "assignments", null, 0, 1, Platform.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPlatform_Targets(), theTargetsPackage.getTargets(), null, "targets", null, 0, 1, Platform.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
