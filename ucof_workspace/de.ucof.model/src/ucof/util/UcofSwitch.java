 ...
 * @generated
 */
public class UcofSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case UcofPackage.PLATFORM: {
				Platform platform = (Platform)theEObject;
				T result = casePlatform(platform);
				if (result == null) result = caseSuperIdentifierType(platform);
				if (result == null) result = caseSuperTrackingType(platform);
