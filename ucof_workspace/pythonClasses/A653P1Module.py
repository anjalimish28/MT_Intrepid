...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! A653P1Module.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class A653P1Module(SuperA653ModuleType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "devicetypes" and not reference_name.lower() == "a653p1module":
      element.set("xsi:type", "de.ucof.model.devices.devicetypes:A653P1Module")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type A653P1Module
    obj = A653P1Module()  
