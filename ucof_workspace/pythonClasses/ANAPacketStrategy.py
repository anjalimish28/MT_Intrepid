...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! ANAPacketStrategy.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class ANAPacketStrategy(SuperPacketStrategyType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "packageStrategyTypes" and not reference_name.lower() == "anapacketstrategy":
      element.set("xsi:type", "de.ucof.model.communication.configECIC.packageStrategyTypes:ANAPacketStrategy")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type ANAPacketStrategy
    obj = ANAPacketStrategy()  
