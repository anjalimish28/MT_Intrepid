...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! Blackboard.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class Blackboard(SuperIntraCommunicationPortType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "ports" and not reference_name.lower() == "blackboard":
      element.set("xsi:type", "de.ucof.model.devices.ports:Blackboard")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type Blackboard
    obj = Blackboard()  
