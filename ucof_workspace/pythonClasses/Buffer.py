...
#import super types
from SuperIntraCommunicationPortType import SuperIntraCommunicationPortType

#import children classes

# -------------------------------------------------------------------
# Automatically generated class from ecore model!! Buffer.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class Buffer(SuperIntraCommunicationPortType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "ports" and not reference_name.lower() == "buffer":
      element.set("xsi:type", "de.ucof.model.devices.ports:Buffer")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type Buffer
    obj = Buffer()  
