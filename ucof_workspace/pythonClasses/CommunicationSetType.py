...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! CommunicationSetType.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class CommunicationSetType(SuperSetType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "communication" and not reference_name.lower() == "communicationsettype":
      element.set("xsi:type", "de.ucof.model.communication:CommunicationSetType")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type CommunicationSetType
    obj = CommunicationSetType()  
