...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! ConnectionPin.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class ConnectionPin(SuperIdentifierType, SuperTrackingType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "connectors" and not reference_name.lower() == "connectionpin":
      element.set("xsi:type", "de.ucof.model.communication.connectors:ConnectionPin")  
    ...
    if self.connectionPinRole is not None:
      element.set("connectionPinRole", str(self.connectionPinRole))  
    # Convert children to nested XML elements
    return element

  def from_xml(self, xml_element):
    # Instantiate an object of type ConnectionPin
    obj = ConnectionPin()  
    ...
    if "connectionPinRole" in xml_element.attrib:
        obj.connectionPinRole = xml_element.get("connectionPinRole")
