...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! DataTimestamp.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class DataTimestamp(SuperIdentifierType, SuperTrackingType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
    ...
    self.version = None
    self.enable = None
    self.sampleDataTimestampOffset = None
    #children (references)
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "streamTypes" and not reference_name.lower() == "datatimestamp":
      element.set("xsi:type", "de.ucof.model.communication.configECIC.streamTypes:DataTimestamp")  
    ...
    if self.enable is not None:
      element.set("enable", str(self.enable))  
    if self.sampleDataTimestampOffset is not None:
      element.set("sampleDataTimestampOffset", str(self.sampleDataTimestampOffset))  
    # Convert children to nested XML elements
    return element

  def from_xml(self, xml_element):
    # Instantiate an object of type DataTimestamp
    obj = DataTimestamp()  
    ...
    if "enable" in xml_element.attrib:
        obj.enable = xml_element.get("enable")
    if "sampleDataTimestampOffset" in xml_element.attrib:
        obj.sampleDataTimestampOffset = xml_element.get("sampleDataTimestampOffset")
