...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! DevicePorts.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class DevicePorts(SuperTrackingType, SuperIdentifierType):
  def __init__(self):
    #attributes
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "etypes" and not reference_name.lower() == "deviceports":
      element.set("xsi:type", "de.ucof.model.common.etypes:DevicePorts")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type DevicePorts
    obj = DevicePorts()  
