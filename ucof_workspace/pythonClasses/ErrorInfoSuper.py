...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! ErrorInfoSuper.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class ErrorInfoSuper(SuperIdentifierType, SuperTrackingType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "healthmanagement" and not reference_name.lower() == "errorinfosuper":
      element.set("xsi:type", "de.ucof.model.healthmanagement:ErrorInfoSuper")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type ErrorInfoSuper
    obj = ErrorInfoSuper()  
