...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! EthernetRX.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class EthernetRX(SuperEthernetMessageType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "basedonethernet" and not reference_name.lower() == "ethernetrx":
      element.set("xsi:type", "de.ucof.model.communication.basedonethernet:EthernetRX")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type EthernetRX
    obj = EthernetRX()  
