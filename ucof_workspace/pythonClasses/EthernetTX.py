...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! EthernetTX.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class EthernetTX(SuperEthernetMessageType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "basedonethernet" and not reference_name.lower() == "ethernettx":
      element.set("xsi:type", "de.ucof.model.communication.basedonethernet:EthernetTX")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type EthernetTX
    obj = EthernetTX()  
