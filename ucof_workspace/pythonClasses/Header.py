...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! Header.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class Header(SuperIdentifierType, SuperTrackingType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "configECIC" and not reference_name.lower() == "header":
      element.set("xsi:type", "de.ucof.model.communication.configECIC:Header")  
    ...
    if self.transportTimestamp is not None:
      element.set("transportTimestamp", str(self.transportTimestamp))  
    # Convert children to nested XML elements
    return element

  def from_xml(self, xml_element):
    # Instantiate an object of type Header
    obj = Header()  
    ...
    if "transportTimestamp" in xml_element.attrib:
        obj.transportTimestamp = xml_element.get("transportTimestamp")
