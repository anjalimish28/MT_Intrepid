...
class IOModule(SuperA653ModuleType):
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "devicetypes" and not reference_name.lower() == "iomodule":
      element.set("xsi:type", "de.ucof.model.devices.devicetypes:IOModule")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type IOModule
    obj = IOModule()  
