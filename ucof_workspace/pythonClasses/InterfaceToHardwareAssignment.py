...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! InterfaceToHardwareAssignment.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class InterfaceToHardwareAssignment(SuperAssignmentType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "assignments" and not reference_name.lower() == "interfacetohardwareassignment":
      element.set("xsi:type", "de.ucof.model.assignments:InterfaceToHardwareAssignment")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type InterfaceToHardwareAssignment
    obj = InterfaceToHardwareAssignment()  
