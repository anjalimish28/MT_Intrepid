...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! InterfaceToPort2PortAssignment.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class InterfaceToPort2PortAssignment(SuperAssignmentType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "assignments" and not reference_name.lower() == "interfacetoport2portassignment":
      element.set("xsi:type", "de.ucof.model.assignments:InterfaceToPort2PortAssignment")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type InterfaceToPort2PortAssignment
    obj = InterfaceToPort2PortAssignment()  
