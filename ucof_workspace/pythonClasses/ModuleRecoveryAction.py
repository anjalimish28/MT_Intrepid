...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! ModuleRecoveryAction.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class ModuleRecoveryAction(ModulePartitionLevelAction):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "healthmanagement" and not reference_name.lower() == "modulerecoveryaction":
      element.set("xsi:type", "de.ucof.model.healthmanagement:ModuleRecoveryAction")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type ModuleRecoveryAction
    obj = ModuleRecoveryAction()  
