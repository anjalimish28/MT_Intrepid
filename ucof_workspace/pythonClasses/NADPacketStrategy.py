...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! NADPacketStrategy.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class NADPacketStrategy(SuperPacketStrategyType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "packageStrategyTypes" and not reference_name.lower() == "nadpacketstrategy":
      element.set("xsi:type", "de.ucof.model.communication.configECIC.packageStrategyTypes:NADPacketStrategy")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type NADPacketStrategy
    obj = NADPacketStrategy()  
