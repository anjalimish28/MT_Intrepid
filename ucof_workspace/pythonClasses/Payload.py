...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! Payload.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class Payload(SuperIdentifierType, SuperTrackingType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "communication" and not reference_name.lower() == "payload":
      element.set("xsi:type", "de.ucof.model.communication:Payload")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type Payload
    obj = Payload()  
