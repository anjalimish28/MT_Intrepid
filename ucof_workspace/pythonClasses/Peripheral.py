...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! Peripheral.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class Peripheral(SuperA653ModuleType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "devicetypes" and not reference_name.lower() == "peripheral":
      element.set("xsi:type", "de.ucof.model.devices.devicetypes:Peripheral")  
    ...
    if self.peripheralType is not None:
      element.set("peripheralType", str(self.peripheralType))  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type Peripheral
    obj = Peripheral()  
    ...
    if "peripheralType" in xml_element.attrib:
        obj.peripheralType = xml_element.get("peripheralType")
