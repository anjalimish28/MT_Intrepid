...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! QueuingPort.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class QueuingPort(SuperInterCommunicationPortType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "etypes" and not reference_name.lower() == "queuingport":
      element.set("xsi:type", "de.ucof.model.common.etypes:QueuingPort")  
    ...
    if self.maxNumberOfMessages is not None:
      element.set("maxNumberOfMessages", str(self.maxNumberOfMessages))  
    # Convert children to nested XML elements
    return element

  def from_xml(self, xml_element):
    # Instantiate an object of type QueuingPort
    obj = QueuingPort()  
    ...
    if "maxNumberOfMessages" in xml_element.attrib:
        obj.maxNumberOfMessages = xml_element.get("maxNumberOfMessages")
