...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! SuperA653ModuleType.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class SuperA653ModuleType(SuperPlatformDeviceType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "devicetypes" and not reference_name.lower() == "supera653moduletype":
      element.set("xsi:type", "de.ucof.model.devices.devicetypes:SuperA653ModuleType")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type SuperA653ModuleType
    obj = SuperA653ModuleType()  
