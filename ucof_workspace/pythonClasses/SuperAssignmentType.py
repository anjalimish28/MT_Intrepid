...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! SuperAssignmentType.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class SuperAssignmentType(SuperIdentifierType, SuperTrackingType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "assignments" and not reference_name.lower() == "superassignmenttype":
      element.set("xsi:type", "de.ucof.model.assignments:SuperAssignmentType")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type SuperAssignmentType
    obj = SuperAssignmentType()  
