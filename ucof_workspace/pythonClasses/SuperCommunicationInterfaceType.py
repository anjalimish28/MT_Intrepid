...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! SuperCommunicationInterfaceType.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class SuperCommunicationInterfaceType(SuperIdentifierType, SuperTrackingType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "communication" and not reference_name.lower() == "supercommunicationinterfacetype":
      element.set("xsi:type", "de.ucof.model.communication:SuperCommunicationInterfaceType")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type SuperCommunicationInterfaceType
    obj = SuperCommunicationInterfaceType()  
