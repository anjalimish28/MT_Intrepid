...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! SuperFunctionType.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class SuperFunctionType(SuperIdentifierType, SuperTrackingType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "functions" and not reference_name.lower() == "superfunctiontype":
      element.set("xsi:type", "de.ucof.model.devices.functions:SuperFunctionType")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type SuperFunctionType
    obj = SuperFunctionType()  
