...
#import super types
from SuperPortType import SuperPortType

#import children classes

# -------------------------------------------------------------------
# Automatically generated class from ecore model!! SuperInterCommunicationPortType.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class SuperInterCommunicationPortType(SuperPortType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "etypes" and not reference_name.lower() == "superintercommunicationporttype":
      element.set("xsi:type", "de.ucof.model.common.etypes:SuperInterCommunicationPortType")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type SuperInterCommunicationPortType
    obj = SuperInterCommunicationPortType()  
