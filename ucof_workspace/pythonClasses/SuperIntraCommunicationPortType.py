...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! SuperIntraCommunicationPortType.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class SuperIntraCommunicationPortType(SuperPortType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "ports" and not reference_name.lower() == "superintracommunicationporttype":
      element.set("xsi:type", "de.ucof.model.devices.ports:SuperIntraCommunicationPortType")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type SuperIntraCommunicationPortType
    obj = SuperIntraCommunicationPortType()  
