...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! SuperPlatformDeviceType.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class SuperPlatformDeviceType(SuperDeviceType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "devices" and not reference_name.lower() == "superplatformdevicetype":
      element.set("xsi:type", "de.ucof.model.devices:SuperPlatformDeviceType")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type SuperPlatformDeviceType
    obj = SuperPlatformDeviceType()  
