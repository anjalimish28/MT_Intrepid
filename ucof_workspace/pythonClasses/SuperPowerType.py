...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! SuperPowerType.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class SuperPowerType(SuperIdentifierType, SuperTrackingType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "powergrid" and not reference_name.lower() == "superpowertype":
      element.set("xsi:type", "de.ucof.model.targets.powergrid:SuperPowerType")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type SuperPowerType
    obj = SuperPowerType()  
