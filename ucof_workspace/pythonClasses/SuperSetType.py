...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! SuperSetType.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class SuperSetType(SuperIdentifierType, SuperTrackingType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "etypes" and not reference_name.lower() == "supersettype":
      element.set("xsi:type", "de.ucof.model.common.etypes:SuperSetType")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type SuperSetType
    obj = SuperSetType()  
