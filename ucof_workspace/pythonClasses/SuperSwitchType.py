...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! SuperSwitchType.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class SuperSwitchType(SuperA653ModuleType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "devicetypes" and not reference_name.lower() == "superswitchtype":
      element.set("xsi:type", "de.ucof.model.devices.devicetypes:SuperSwitchType")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type SuperSwitchType
    obj = SuperSwitchType()  
