...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! TriggerWord.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class TriggerWord(SuperIdentifierType, SuperTrackingType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "packageStrategyTypes" and not reference_name.lower() == "triggerword":
      element.set("xsi:type", "de.ucof.model.communication.configECIC.packageStrategyTypes:TriggerWord")  
    ...
    if self.Label is not None:
      element.set("Label", str(self.Label))  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type TriggerWord
    obj = TriggerWord()  
    ...
    if "Label" in xml_element.attrib:
        obj.Label = xml_element.get("Label")
