...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! UDPSocketExtension.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class UDPSocketExtension(SuperIdentifierType, SuperTrackingType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "assignments" and not reference_name.lower() == "udpsocketextension":
      element.set("xsi:type", "de.ucof.model.assignments:UDPSocketExtension")  
    ...
    if self.portSelection is not None:
      element.set("portSelection", str(self.portSelection))  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type UDPSocketExtension
    obj = UDPSocketExtension()  
    ...
    if "portSelection" in xml_element.attrib:
        obj.portSelection = xml_element.get("portSelection")
