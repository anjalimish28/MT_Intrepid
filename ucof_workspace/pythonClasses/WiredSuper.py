...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! WiredSuper.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class WiredSuper(SuperIdentifierType, SuperTrackingType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "basedonwired" and not reference_name.lower() == "wiredsuper":
      element.set("xsi:type", "de.ucof.model.communication.basedonwired:WiredSuper")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type WiredSuper
    obj = WiredSuper()  
