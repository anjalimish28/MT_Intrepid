...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! adcPort.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class adcPort(SuperHardwarePortType, SuperElectricalInterfaceType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "adc" and not reference_name.lower() == "adcport":
      element.set("xsi:type", "de.ucof.model.targets.adc:adcPort")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type adcPort
    obj = adcPort()  
