...
from canTransceiverPort import canTransceiverPort


# -------------------------------------------------------------------
# Automatically generated class from ecore model!! canTransceiverPorts.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class canTransceiverPorts(SuperTrackingType, SuperIdentifierType):
  def __init__(self):
    #attributes
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "cantransceiver" and not reference_name.lower() == "cantransceiverports":
      element.set("xsi:type", "de.ucof.model.targets.cantransceiver:canTransceiverPorts")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type canTransceiverPorts
    obj = canTransceiverPorts()  
    ...
    for child_element in xml_element.findall("port"):
      ...
      if not xsi_type:
        child = canTransceiverPort.from_xml(self, child_element)
        child.parent = obj
