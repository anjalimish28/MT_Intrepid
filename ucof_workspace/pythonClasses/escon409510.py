...
from esconPorts import esconPorts


# -------------------------------------------------------------------
# Automatically generated class from ecore model!! escon409510.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class escon409510(SuperTargetType, SuperPowerType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "motorcontroller" and not reference_name.lower() == "escon409510":
      element.set("xsi:type", "de.ucof.model.targets.motorcontroller:escon409510")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type escon409510
    obj = escon409510()  
    ...
    if child_element is not None:  
      xsi_type = child_element.get("{http://www.w3.org/2001/XMLSchema-instance}type")
      if (not xsi_type) or (xsi_type.split(":", 1)[ 1 ].lower() == "esconports"):
        child = esconPorts.from_xml(self, child_element)
        child.parent = obj
        obj.ports = child        
