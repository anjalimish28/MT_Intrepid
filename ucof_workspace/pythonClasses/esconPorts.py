...
from esconPort import esconPort


# -------------------------------------------------------------------
# Automatically generated class from ecore model!! esconPorts.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class esconPorts(SuperTrackingType, SuperIdentifierType):
  def __init__(self):
    #attributes
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "motorcontroller" and not reference_name.lower() == "esconports":
      element.set("xsi:type", "de.ucof.model.targets.motorcontroller:esconPorts")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type esconPorts
    obj = esconPorts()  
    ...
    for child_element in xml_element.findall("port"):
      ...
      if not xsi_type:
        child = esconPort.from_xml(self, child_element)
        child.parent = obj
