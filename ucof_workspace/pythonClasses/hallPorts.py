...
from hallPort import hallPort


# -------------------------------------------------------------------
# Automatically generated class from ecore model!! hallPorts.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class hallPorts(SuperTrackingType, SuperIdentifierType):
  def __init__(self):
    #attributes
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "hallsensor" and not reference_name.lower() == "hallports":
      element.set("xsi:type", "de.ucof.model.targets.hallsensor:hallPorts")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type hallPorts
    obj = hallPorts()  
    ...
    for child_element in xml_element.findall("port"):
      ...
      if not xsi_type:
        child = hallPort.from_xml(self, child_element)
        child.parent = obj
