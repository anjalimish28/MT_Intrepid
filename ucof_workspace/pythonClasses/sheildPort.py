...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! sheildPort.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class sheildPort(SuperHardwarePortType, SuperElectricalInterfaceType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "sheild" and not reference_name.lower() == "sheildport":
      element.set("xsi:type", "de.ucof.model.targets.sheild:sheildPort")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type sheildPort
    obj = sheildPort()  
