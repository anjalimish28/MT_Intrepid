...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! srcDirectionExtension.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class srcDirectionExtension(SuperIdentifierType, SuperTrackingType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "configECIC" and not reference_name.lower() == "srcdirectionextension":
      element.set("xsi:type", "de.ucof.model.communication.configECIC:srcDirectionExtension")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type srcDirectionExtension
    obj = srcDirectionExtension()  
