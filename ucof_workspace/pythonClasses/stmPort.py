...
class stmPort(SuperHardwarePortType):
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "rdc" and not reference_name.lower() == "stmport":
      element.set("xsi:type", "de.ucof.model.targets.rdc:stmPort")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type stmPort
    obj = stmPort()  
