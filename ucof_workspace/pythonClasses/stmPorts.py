...
from stmPort import stmPort


# -------------------------------------------------------------------
# Automatically generated class from ecore model!! stmPorts.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class stmPorts(SuperTrackingType, SuperIdentifierType):
  def __init__(self):
    #attributes
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "rdc" and not reference_name.lower() == "stmports":
      element.set("xsi:type", "de.ucof.model.targets.rdc:stmPorts")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type stmPorts
    obj = stmPorts()  
    ...
    for child_element in xml_element.findall("port"):
      ...
      if not xsi_type:
        child = stmPort.from_xml(self, child_element)
        child.parent = obj
