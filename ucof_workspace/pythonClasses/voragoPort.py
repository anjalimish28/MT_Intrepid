...
# -------------------------------------------------------------------
# Automatically generated class from ecore model!! voragoPort.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class voragoPort(SuperHardwarePortType):
  def __init__(self):
    #attributes
    self.id = None
    self.name = None
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "cpn" and not reference_name.lower() == "voragoport":
      element.set("xsi:type", "de.ucof.model.targets.cpn:voragoPort")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type voragoPort
    obj = voragoPort()  
