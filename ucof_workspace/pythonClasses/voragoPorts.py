...
from voragoPort import voragoPort


# -------------------------------------------------------------------
# Automatically generated class from ecore model!! voragoPorts.
# Don't change here, change in source ecore model
# Code generator by Philipp Chrysalidis in 2025
# ======================================================================

class voragoPorts(SuperTrackingType, SuperIdentifierType):
  def __init__(self):
    #attributes
  ...
  def to_xml(self, reference_name = None):
    ...
    if not reference_name == "cpn" and not reference_name.lower() == "voragoports":
      element.set("xsi:type", "de.ucof.model.targets.cpn:voragoPorts")  
  ...
  def from_xml(self, xml_element):
    # Instantiate an object of type voragoPorts
    obj = voragoPorts()  
    ...
    for child_element in xml_element.findall("port"):
      ...
      if not xsi_type:
        child = voragoPort.from_xml(self, child_element)
        child.parent = obj
